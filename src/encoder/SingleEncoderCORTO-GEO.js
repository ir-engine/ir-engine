...
var DracoFileCreator = /** @class */ (function () {
  ...
  DracoFileCreator.prototype.createEncodedFile = async function (
    ...
    for (var i = this._frameIn; i < frameOut; i++) {
      ...
      var encodedTexture = {byteLength:0};
...
// obj->ply
// for file in /Users/akella/Desktop/3d-mesh-audio/captain_mesh_40k/*.obj
...
// ../corto $file
// end
new DracoFileCreator('crt', 'png', 0, 1009, 'CRT_geometry_Morgan_1000frames.drcs', function () {
  console.log('Converted to Corto Dracosis');
});
