    ...
    return (
      new Promise((resolve, reject) => {
        ...
        .then((m: any) => {
          ...
          ;(material as THREE.Material[]).map(m => ((m as MeshStandardMaterial).skinning = true))

          const mesh = new THREE.SkinnedMesh(geometry, new THREE.MultiMaterial(material as THREE.Material[]))
