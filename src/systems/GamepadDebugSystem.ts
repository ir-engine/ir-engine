  ...
  execute(): void {
    ...
    this.queries.gamepad.results.forEach(ent => {
      ...
      if (gp.connected) {
        ...
        if (gp.buttonA === ButtonState.PRESSED) console.log("Button A pressed")

        if (gp.buttonB === ButtonState.PRESSED) console.log("Button B pressed")

        if (gp.buttonX === ButtonState.PRESSED) console.log("Button X pressed")

        if (gp.buttonY === ButtonState.PRESSED) console.log("Button Y pressed")
      }
    })
  }
}
