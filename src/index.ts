...
export function initializeInputSystems(
  ...
  if (options.keyboard) {
    ...
    if (options.debug)
      console.log(
        "Registered KeyboardInputSystem and added KeyboardInputState component to input entity"
      )
  }
  ...
  if (options.mouse) {
    ...
    if (options.debug)
      console.log(
        "Registered MouseInputSystem and added MouseInputState component to input entity"
      )
  }
