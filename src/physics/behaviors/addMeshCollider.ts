...
export const addMeshCollider: Behavior = (
  entity: Entity,
  args: { obj: any; objArgs: any; parentEntity: Entity }
) => {
//  const object3d = args.obj ? new args.obj(args.objArgs) : new Object3D()

  if (!WorldComponent.instance.world.hasRegisteredComponent(Collider as any)) {
    WorldComponent.instance.world.registerComponent(Collider)
  }
