...
export class VehicleSystem extends ECSY.System {
  execute(dt, t) {
    for (let entity of this.queries.physicsBody.added) {
      ...
      if (physicsBody.geometryType == 'box') {
        shape = new CANNON.Box(
         new CANNON.Vec3(
           physicsBody.scale.x / 2,
           physicsBody.scale.y / 2,
           physicsBody.scale.z / 2
         ));
      } else {
      ...
      let body = new CANNON.Body({
        ...
        position: new CANNON.Vec3(
          physicsBody.startPosition.x,
          physicsBody.startPosition.y,
          physicsBody.startPosition.z)
      });
      body.addShape(shape);
    ...
    //  body.angularDamping = 0.5;
      ...
      entity.getMutableComponent(PhysicsBody).body = body
