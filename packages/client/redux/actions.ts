...
export const SHOWROOM_ENABLED_SET = 'SHOWROOM_ENABLED_SET';
export const SHOWROOM_LOCATION_RETRIEVED = 'SHOWROOM_LOCATION_RETRIEVED';
export const SHOWROOM_LOCATION_SET = 'SHOWROOM_LOCATION_SET';