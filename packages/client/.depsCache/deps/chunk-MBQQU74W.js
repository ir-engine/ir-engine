...
var StepEdge = (0, import_react2.memo)((props) => (0, import_jsx_runtime.jsx)(SmoothStepEdge, { ...props, pathOptions: (0, import_react2.useMemo)(() => ({ borderRadius: 0, offset: props.pathOptions?.offset }), [props.pathOptions?.offset]) }));
...
function handlePointerDown({ event, handleId, nodeId, onConnect, isTarget, getState, setState, isValidConnection, edgeUpdaterType, onEdgeUpdateEnd }) {
  ...
  const { x, y } = getEventPosition(event);
  const clickedHandle = doc2?.elementFromPoint(x, y);
...
var selector = (s) => {
  ...
  return s.getNodes().every((n) => n[internalsSymbol]?.handleBounds !== void 0);
};
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MBQQU74W.js.map
