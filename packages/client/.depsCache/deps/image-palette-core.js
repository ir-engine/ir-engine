...
var require_color_thief = __commonJS({
  "../../node_modules/image-palette-core/es/color-thief.js"(exports, module) {
    var iAmOnNode = false;
    var Canvas;
    var Image;
    var fs;
    ...
    var CanvasImage = function CanvasImage2(image) {
      if (iAmOnNode) {
    ...
    var ColorThief2 = function ColorThief3() {
    };
    ColorThief2.prototype.getColor = function(sourceImage, quality, allowWhite) {
    ...
    ColorThief2.prototype.getPalette = function(sourceImage, colorCount, quality, allowWhite) {
    ...
    ColorThief2.prototype.getPaletteFromPixels = function(pixels, pixelCount, colorCount, quality) {
      var allowWhite = true;
      var pixelArray = [];
...
// ../../node_modules/image-palette-core/node_modules/color-name/index.js
var require_color_name2 = __commonJS({
  "../../node_modules/image-palette-core/node_modules/color-name/index.js"(exports, module) {
    "use strict";
    module.exports = {
      "aliceblue": [240, 248, 255],
      "antiquewhite": [250, 235, 215],
...
// ../../node_modules/image-palette-core/node_modules/color-convert/conversions.js
var require_conversions = __commonJS({
  "../../node_modules/image-palette-core/node_modules/color-convert/conversions.js"(exports, module) {
...
// ../../node_modules/image-palette-core/node_modules/color-convert/route.js
var require_route = __commonJS({
  "../../node_modules/image-palette-core/node_modules/color-convert/route.js"(exports, module) {
...
// ../../node_modules/image-palette-core/node_modules/color-convert/index.js
var require_color_convert = __commonJS({
  "../../node_modules/image-palette-core/node_modules/color-convert/index.js"(exports, module) {
    var conversions = require_conversions();
...
// ../../node_modules/image-palette-core/node_modules/color/index.js
var require_color = __commonJS({
  "../../node_modules/image-palette-core/node_modules/color/index.js"(exports, module) {
    "use strict";
...
var import_color_thief = __toESM(require_color_thief());
...
var THRESHOLD_CONTRAST_RATIO = 1;
var MINIMUM_CONTRAST_RATIO = 4.5;
var totalPixelCount = 0;
var RGBToPixelCountMap = {};
function getRGBRange(color) {
  var rgb = (0, import_lodash3.default)(color.rgb().array()).reverse();
  var _rgb = _slicedToArray(rgb, 3), max = _rgb[0], med = _rgb[1], min = _rgb[2];
  return (max - min) / 10;
}
...
function getColorPalette(image, colorThief) {
  ...
  return colorThief.getPalette(image).map(function(color) {
    var colorWrapper = new import_color.default(color.rgb);
...
function getImagePalette(image, colorThief) {
  colorThief = colorThief || new import_color_thief.default();
  ...
  palettes.forEach(function(dominantColor, index) {
    var pairs = WCAGCompliantColorPairs[dominantColor] = [];
    palettes.forEach(function(color2) {
      var contrast = dominantColor.contrast(color2);
      if (contrast > THRESHOLD_CONTRAST_RATIO) {
        var range = getRGBRange(color2);
        if (contrast < MINIMUM_CONTRAST_RATIO) {
          ...
          while (contrast < MINIMUM_CONTRAST_RATIO) {
            var newColor = lighten ? color2.lighten(delta) : color2.darken(delta);
            if (newColor.hex() === color2.hex()) {
              break;
            }
        ...
        pairs.push({ color: color2, score, contrast });
      }
    });
  });
  var backgroundColor = getMostDominantPrimaryColor(WCAGCompliantColorPairs);
  var _WCAGCompliantColorPa = _slicedToArray(WCAGCompliantColorPairs[backgroundColor], 3), color = _WCAGCompliantColorPa[0], alternativeColor = _WCAGCompliantColorPa[1], accentColor = _WCAGCompliantColorPa[2];
  if (!alternativeColor) {
...
export {
  getImagePalette as default
};
/*! Bundled license information:

image-palette-core/es/color-thief.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=image-palette-core.js.map
