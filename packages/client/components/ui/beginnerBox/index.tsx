    ...
    <>
      ...
      >
        ...
        <DialogContent>
          ...
          Welcome to the The Overlay immersive store. You can hang out and explore this virtual place with others. Walk around and discover things to see and do. Invite your friends and share the experience.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
