export const ConnectionTexts = {
  facebook: {
    connected: {
      ...
      descr: [
        'You can now sign in to The Overlay using your Facebook account.',
    ...
    notConnected: {
      ...
      descr: [
        'If you want to sign in to The Overlay using your Facebook account,',
  ...
  github: {
    connected: {
      ...
      descr: [
        'You can now sign in to The Overlay using your Github account.',
    ...
    notConnected: {
      ...
      descr: [
        'If you want to sign in to The Overlay using your Github account,',
  ...
  google: {
    connected: {
      ...
      descr: [
        'You can now sign in to The Overlay using your Google account.',
    ...
    notConnected: {
      ...
      descr: [
        'If you want to sign in to The Overlay using your Google account,',
  ...
  email: {
    connected: {
      ...
      descr: [
        'You can now sign in to The Overlay using your Email.'
      ]
    },
    notConnected: {
      header: 'You are not connected to Email Link',
      descr: [
        'If you want to sign in to The Overlay using your Email Link,',
  ...
  sms: {
    connected: {
      ...
      descr: [
        'You can now sign in to The Overlay using your SMS.'
      ]
    },
    notConnected: {
      header: 'You are not connected to SMS Link',
      descr: [
        'If you want to sign in to The Overlay using your SMS Link,',
  ...
  password: {
    connected: {
      ...
      descr: [
        'You can now sign in to The Overlay using your Email/Password.'
      ]
    },
    notConnected: {
      header: 'You are not connected to Email/Password account',
      descr: [
        'If you want to sign in to The Overlay using your Email/Password,',
