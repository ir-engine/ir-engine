...
export default class WayPointNode extends EditorNodeMixin(THREE.Object3D) {
  ...
  constructor(editor) {
    ...
    if (wayPointHelperModel) {
      ...
      console.warn(
        "WayPointNode: helper model was not loaded before creating a new WayPointNode"
      );
      this.helper = null;
    }
  }
  ...
  static async deserialize(editor, json) {
    ...
    node.willMaintainInitialOrientation =
      waypoint.props.willMaintainInitialOrientation;
    return node;
  }
  prepareForExport() {
