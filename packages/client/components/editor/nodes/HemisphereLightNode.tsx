...
export default class HemisphereLightNode extends EditorNodeMixin(
  PhysicalHemisphereLight
) {
  ...
  static async deserialize(editor, json) {
    ...
    const { skyColor, groundColor, intensity } = json.components.find(
      c => c.name === "hemisphere-light"
    ).props;
