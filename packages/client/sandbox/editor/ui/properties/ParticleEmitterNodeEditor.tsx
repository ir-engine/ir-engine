...
> {
  ...
  onChangeLifetimeRandomness = lifetimeRandomness => {
    this.props.editor.setPropertySelected(
      "lifetimeRandomness",
      lifetimeRandomness
    );
    this.updateParticles();
      ...
      >
        ...
        <InputGroup name="Size Curve">
          <SelectInput
            ...
            value={this.props.node.sizeCurve}
        ...
        <InputGroup name="Start Color">
          <ColorInput
            value={this.props.node.startColor}
        ...
        <InputGroup name="Middle Color">
          <ColorInput
            value={this.props.node.middleColor}
        ...
        <InputGroup name="End Color">
          <ColorInput
            value={this.props.node.endColor}
