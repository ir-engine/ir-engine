    ...
    render(props) {
      return (
        <OnboardingDialog {...props}>
          <h2>Introduction</h2>
          <h1>Welcome{configs.isXR3() ? " to Editor" : ""}</h1>
    ...
    render(props) {
      return (
        <OnboardingDialog {...props} disablePrev>
          ...
          <p>
            Once your project is ready, you can publish it{configs.isXR3() && " to Hubs"} and invite your friends with
    ...
    render(props) {
      return (
        <OnboardingDialog {...props} disablePrev disableSkip>
          ...
          <h1>Great Job!</h1>
          <p>
            Great job! You&#39;ve touched all the basics {configs.isXR3() && "of Editor "}and published a scene{" "}
            {configs.isXR3() && "to Hubs"}! To get started on your own scene check out your projects page. Or click
