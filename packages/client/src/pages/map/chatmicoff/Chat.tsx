        ...
        <div>
            ...
            <section className={styles.messaging}>
              <div className={styles.user}> 
                ...
                <span className={styles.send}><SendRoundedIcon fontSize="small"/></span>
              </div>
            </section>

            <section className={styles.bottomicon}>
              <span className={styles.closed}><CloseIcon front-size="large"/></span>
               <span className={styles.mic}><MicNoneTwoToneIcon/></span>
            </section>
