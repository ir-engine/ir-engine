...
const ErrorBoundary = ({ children, local }: { children: any; local?: boolean }) => {
  return (
    <ErrorBoundaryBugsnag FallbackComponent={local ? FallbackLocal : FallbackGlobal}>{children}</ErrorBoundaryBugsnag>
  )
}
