...
const LogoAndText = memo(({ gold, inLeague, updating }: Props) => {
  return (
    <a className={inLeague ? 'navbar-brand text-muted d-none d-md-inline' : 'navbar-brand text-muted'} href="/">
      <img
        alt=""
        className="spin"
        width="18"
        height="18"
        src={gold ? '/src/pages/game/ui/assets/ico/logo-gold.png' : '/src/pages/game/ui/assets/ico/logo.png'}
        style={{
