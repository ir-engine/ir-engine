...
const Pagination = ({
  ...
  for (let i = firstShownPage; i <= lastShownPage; i++) {
    numberedPages.push(
      <li key={i} className={classNames('page-item', i === currentPage ? 'active' : null)}>
        {i === currentPage ? (
  ...
  return (
    <div className="datatable-pagination">
      <ul className="pagination">
        ...
        >
          <a className="page-link" onClick={() => showPrev && onClick(currentPage - 1)}>
            ← Prev
          </a>
        </li>
        {numberedPages}
        ...
        >
          <a className="page-link" onClick={() => showNext && onClick(currentPage + 1)}>
            Next →
          </a>
        </li>
      </ul>
