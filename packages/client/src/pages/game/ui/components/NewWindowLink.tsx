...
const NewWindowLink = ({ parts }: Props) => {
  ...
  return (
    ...
    >
      ...
      <path d="M107 171L216 55v75-75h-75" fill="none" strokeWidth="30" strokeLinejoin="bevel" />
...
NewWindowLink.propTypes = {
  parts: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.number, PropTypes.string]))
}
