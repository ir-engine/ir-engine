...
const NegotiateButtons = ({
  ...
  const signDisabled =
    !canGoOverCap &&
    (!!disabled || (contractAmount / 1000 > capSpace + 1 / 1000 && contractAmount / 1000 > (minContract + 1) / 1000))
  return (
    <div className="btn-group">
      ...
      <button
        ...
        onClick={async () => {
          const errorMsg = await toWorker('main', 'sign', p.pid, contractAmount, p.contract.exp)
