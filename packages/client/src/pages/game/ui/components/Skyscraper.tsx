import React, { memo, useEffect } from 'react' // Ensure there is enough room to display 160px wide ad with 15px margins next to 1200px wide container
...
export const updateSkyscraperDisplay = () => {
  ...
  if (div) {
    ...
    if (documentElement && documentElement.clientWidth >= widthCutoff && !gold) {
      if (!displayed) {
