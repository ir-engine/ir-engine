...
const MultiTeamMenu = () => {
  ...
  return (
    <div className="multi-team-menu d-flex align-items-end" style={{ bottom }}>
      <button className="btn btn-link p-0 mb-1" disabled={prevDisabled} onClick={prev} title="Previous Team">
        <span className="glyphicon glyphicon-menu-left" />
      </button>
      <div className="flex-fill px-1">
        <select className="form-control" onChange={handleChange} value={state.userTid}>
          {teams.map((t) => (
      ...
      <button className="btn btn-link p-0 mb-1" disabled={nextDisabled} onClick={next} title="Next Team">
