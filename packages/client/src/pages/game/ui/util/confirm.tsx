...
const Confirm = confirmable(({ show, proceed, confirmation, defaultValue, okText, cancelText }: any) => {
  okText = okText ?? 'OK'
  ...
  const cancel = useCallback(() => proceed(defaultValue === undefined ? false : null), [defaultValue, proceed])
  ...
  return (
    <Modal show={show} onHide={cancel} className="highest-modal" backdropClassName="highest-modal-backdrop">
      <Modal.Body>
        {confirmation}
