...
const routes = () => {
  return {
    ...
    '/l/:lid/player_stats/:abbrev/:season/:statType/:playoffs': genPage('playerStats'),
    ...
    '/l/:lid/league_stats/:abbrev/:teamOpponent/:playoffs': genPage('leagueStats'),
