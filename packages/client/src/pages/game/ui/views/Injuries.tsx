...
const Injuries = ({ abbrev, challengeNoRatings, injuries, season, stats, userTid }: View<'injuries'>) => {
  useTitleBar({
    title: 'Injuries',
  ...
  return (
    <>
      ...
      <DataTable cols={cols} defaultSort={[cols.length - 3, 'asc']} name="Injuries" pagination rows={rows} />
    </>
  )
}
