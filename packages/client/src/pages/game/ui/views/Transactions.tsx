...
const Transactions = ({ abbrev, eventType, events, season, tid }: View<'transactions'>) => {
  useTitleBar({
    title: 'Transactions',
  ...
  const moreLinks =
    abbrev !== 'all' ? (
      <MoreLinks type="team" page="depth" abbrev={abbrev} tid={tid} season={season !== 'all' ? season : undefined} />
    ) : (
      <p>
