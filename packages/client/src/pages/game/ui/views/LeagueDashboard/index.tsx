        ...
        <div className="col-xl-7 col-lg-8">
          <div className="row">
            ...
            <div className="col-sm-8">
                ...
                <span style={{ fontSize: '1.5rem' }}>
                  {playoffRoundsWon < 0 ? (
                    ...
                    <span className="d-none d-sm-inline">
                      {helpers.roundsWonText(playoffRoundsWon, numPlayoffRounds, numConfs)}
                    </span>
                  )}
                </span>
              </div>
              ...
              <div className="row">
                <div className="col-6">
                  <Leaders leagueLeaders={leagueLeaders} teamLeaders={teamLeaders} />
                  <h2>Inbox</h2>
                  {messages.length === 0 ? (
                    <p>No messages!</p>
                  ) : (
                    <>
                      <table className="table table-bordered table-sm messages-table">
                        <tbody>
                          {messages.map((m) => (
                            <tr key={m.mid} className={m.read ? undefined : 'font-weight-bold'}>
                              <td className="year">
                                <a href={helpers.leagueUrl(['message', m.mid])}>{m.year}</a>
                              </td>
                              <td className="from">
                                <a href={helpers.leagueUrl(['message', m.mid])}>{m.from}</a>
                              </td>
                            </tr>
                          ))}
                        </tbody>
