    ...
    <>
      ...
      {challengeNoRatings ? (
        <p className="alert alert-danger d-inline-block">
          <b>Challenge Mode:</b> All player ratings are hidden, except for retired players.
        </p>
      ) : null}
      ...
      <DataTable cols={cols} defaultSort={[6, 'desc']} name="PlayerRatings" pagination rows={rows} />
    </>
  )
}
