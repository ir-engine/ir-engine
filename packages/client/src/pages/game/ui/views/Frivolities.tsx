...
import type { MenuItemHeader, MenuItemLink, MenuItemText } from '../../common/types'
...
const frivolities = {
  Draft: [
    {
      ...
      description: 'The best player ever drafted at each position in the draft.'
    },
    {
      urlParts: ['most', 'busts'],
      name: 'Biggest Busts',
  ...
  'Player Bios': [
    {
      urlParts: ['colleges'],
      name: 'Colleges',
      description: 'See which colleges have had the most successful pro players.'
    },
    {
      urlParts: ['countries'],
      name: 'Countries',
      description: 'See which countries have had the most successful pro players.'
    },
    {
      urlParts: ['jersey_numbers'],
      name: 'Jersey Numbers',
      description: 'See which jersey numbers have been used by the most successful pro players.'
    },
    {
      urlParts: ['relatives'],
      name: 'Relatives',
    ...
    },
    {
      ...
      name: 'Tragic Deaths',
      description: 'View all the tragic deaths that have occurred in your league.'
    }
  ],
  Teams: [
    {
      ...
      description: 'Color-coded visualization of year-to-year changes in roster.'
    },
    {
      urlParts: ['teams', 'best'],
      name: 'Best Teams',
  ...
  Trades: [
    ...
    },
    {
      ...
      description: "Trades where one team's assets produced a lot more value than the other."
    }
  ],
  'Player Rankings': [
    {
    ...
    },
    {
      urlParts: ['most', 'goat'],
      name: 'GOAT Lab',
      description: 'Define your own formula to rank the greatest players of all time.'
    },
    {
    ...
    },
    {
      ...
      name: 'Hall of Shame',
      description: 'Worst players who actually got some playing time to show how bad they are.'
    },
    {
    ...
    },
    {
      ...
      description: 'See the most accomplished players who never made the playoffs.'
    },
    {
      urlParts: ['most', 'teams'],
      name: 'Most Teams',
      description: 'See the players who played for the largest number of teams.'
    },
    {
      urlParts: ['most', 'traded'],
      name: 'Most Times Traded',
      description: 'Players who were passed around like... you fill in the blank.'
    },
    {
    ...
    },
    {
      ...
      name: 'Worst Injuries',
      description: 'Players who experienced the largest ovr declines due to injuries.'
    }
  ]
}
...
const Frivolities = () => {
  ...
  const columns: (keyof typeof frivolities)[][] = [['Draft', 'Player Bios', 'Teams', 'Trades'], ['Player Rankings']]

  return (
    <>
      <p>
        In the spirit of <a href="https://www.basketball-reference.com/friv/">Basketball Reference</a>, here is some fun
        stuff.
      </p>

      <p>
        <span className="text-danger">Warning:</span> most of these will be slow if you've played hundreds of seasons in
        this league.
      </p>

      <div className="row" style={style}>
        {columns.map((categories, i) => (
          <div key={i} className={`col-12 col-md-6${i > 0 ? ' mt-3 mt-md-0' : ''}`}>
