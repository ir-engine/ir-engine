...
const NegotiationList = ({
  ...
  return (
    <>
      ...
      <p>
        More: <a href={helpers.leagueUrl(['upcoming_free_agents'])}>Upcoming Free Agents</a>
      </p>

      {!hardCap ? (
        <p>
          You are allowed to go over the salary cap to re-sign your players before they become free agents. If you do
          not re-sign them before free agency begins, they will be free to sign with any team, and you won't be able to
          go over the salary cap to sign them.
        </p>
      ) : null}
      ...
      {hardCap ? (
        <p>
          Your unsigned players are asking for a total of <b>{helpers.formatCurrency(sumContracts, 'M')}</b>.
        </p>
      ) : null}
      ...
      <DataTable cols={cols} defaultSort={[10, 'desc']} name="NegotiationList" rows={rows} />
    </>
  )
}
