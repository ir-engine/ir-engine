...
const GmHistory = ({
  ...
  return (
    <>
      <p>
        More: <a href={helpers.leagueUrl(['team_records', 'by_team', 'your_teams'])}>Your Team Records</a> |{' '}
        <a href={helpers.leagueUrl(['draft_team_history', 'your_teams'])}>Your Draft Picks</a>
      </p>
      ...
      <div className="row">
        ...
        <div className="col-sm-7 col-md-9 mt-3 mt-sm-0">
          <p>
            This GM History page is similar to the <a href={helpers.leagueUrl(['team_history'])}>Team History page</a>,
            except it's not just for one team. It's for every team you were the GM of.
          </p>
          <p>
            Currently, there are two ways to change teams: (1) do a really bad job and the owner will fire you; (2) do a
            really good job and other teams may try to hire you after the playoffs end.
          </p>
