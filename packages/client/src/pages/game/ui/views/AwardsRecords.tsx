...
const formatYear = (year: { [key: string]: { team: string; season: number }[] }) => {
...
const AwardsRecords = ({ awardType, awardTypeVal, awardsRecords, playerCount }: View<'awardsRecords'>) => {
  useTitleBar({
  ...
  return (
    <>
      ...
      <DataTable cols={cols} defaultSort={[1, 'desc']} name="AwardsRecords" rows={rows} pagination />
    </>
  )
}
