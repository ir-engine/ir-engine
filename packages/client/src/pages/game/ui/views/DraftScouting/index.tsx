...
const DraftScouting = ({ challengeNoRatings, draftType, seasons }: View<'draftScouting'>) => {
  ...
  return (
    <>
      ...
      <p>
        The ratings shown are your scouts' projections for what the players' ratings will be when they enter the{' '}
        {!noDraft ? 'draft' : 'league'}. The further in the future, the more uncertainty there is in their estimates.
      </p>
