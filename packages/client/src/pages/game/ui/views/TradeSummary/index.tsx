    ...
    <>
      ...
      <div className="d-lg-flex">
        <div className="d-sm-flex mb-3 mb-lg-0 mr-lg-5">
          {teams.map((t, i) => (
            <div key={t.tid} className={i === 0 ? 'mb-sm-0 mr-sm-5 mb-3' : undefined}>
              <h2>
              ...
              {t.assets.map((asset, i) => {
                if (asset.type === 'player') {
                  return (
                    <div key={i} className="mb-2">
                      ...
                      <div>
                        {helpers.formatCurrency(asset.contract.amount / 1000, 'M')} thru {asset.contract.exp}
                        <br />
                ...
                if (asset.type === 'realizedPick') {
                  return (
                    <div key={i} className="mb-2">
                      <div>
                        <PlayerNameLabels pid={asset.pid} pos={asset.pos} skills={asset.skills} watch={asset.watch}>
                          {asset.name}
                        </PlayerNameLabels>
                      </div>
                      <div>
