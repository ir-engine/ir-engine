...
const DraftTeamHistory = ({
  ...
  const rows = players.map((p) => {
    ...
    return {
      key: p.pid,
      data: [
        <a href={helpers.leagueUrl(['draft_history', p.draft.year])}>{p.draft.year}</a>,
        ...
        p.pos,
        {
          ...
          value: <DraftAbbrev originalTid={p.draft.originalTid} tid={p.draft.tid} season={p.draft.year} />
        },
        p.draft.age,
  ...
  return (
    <>
      ...
      <p>
        Players currently on your team are <span className="text-info">highlighted in blue</span>. Players in the Hall
        of Fame are <span className="text-danger">highlighted in red</span>.
      </p>
