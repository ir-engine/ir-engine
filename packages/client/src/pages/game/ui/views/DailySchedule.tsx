...
const DailySchedule = ({
  ...
  const tradeDeadline = upcoming.length === 1 && upcoming[0].teams[0].tid === -3 && upcoming[0].teams[1].tid === -3

  let noGamesMessage
  if (days.length === 0) {
    noGamesMessage = <NoGamesMessage warnAboutDelete={season < currentSeason} />
  }
    ...
    <>
      ...
      {noGamesMessage ? (
        ...
        <>
          ...
          {tradeDeadline ? (
            <p>Sim one day to move past the trade deadline, and then the next day's games will be available here.</p>
          ) : isToday ? (
            <p>To view a live play-by-play summary of a game, select one of today's games below.</p>
          ) : null}
            ...
            <>
              <div className="row">
                <div className="col-xl-4 col-md-6 col-12">
                  ...
                  <div className="d-flex" style={{ maxWidth: 400, marginRight: isToday ? 62 : 0 }}>
                    {upcomingAndCompleted ? <h2>Upcoming Games</h2> : null}
                    <div className="p-1 ml-auto text-muted" title="Team Overall Rating">
                      Ovr
                    </div>
                    <div
                      className={classNames('text-right p-1 text-muted', 'score-box-spread')}
                  ...
                  const actionStuff =
                    isToday && !tradeDeadline
                      ? {
                          ...
                          actionHighlight: game.teams[0].tid === userTid || game.teams[1].tid === userTid,
                          actionText: (
                            <>
                              Watch
                              <br />
              ...
              >
                <div className="col-xl-4 col-md-6 col-12">
                  ...
                  <div className="d-flex" style={{ maxWidth: 400 }}>
                    ...
                    <div className="score-box-score text-right text-muted p-1" title="Final Score">
                      Score
                    </div>
                  </div>
                </div>
