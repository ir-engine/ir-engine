		...
		descriptionLong: (
			<>
				...
				<p>
					...
					only affect future seasons, not the current season.
				</p>
			</>
		),
		validator: value => {
...
settings.push(
	...
	},
	{
		...
		type: "bool",
		description:
			"Track overtime losses (OTL) separately from regulation losses.",
	},
	{
		category: "Game Modes",
		key: "repeatSeason",
	...
	},
	{
		...
		type: "int",
		description:
			"This will stop game simulation if one of your players is injured for more than N games.",
		customForm: true,
	},
	{
		category: "Injuries",
