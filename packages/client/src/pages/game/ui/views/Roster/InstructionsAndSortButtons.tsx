    ...
    <>
      {editable ? (
        ...
        >
          ...
          <span className="table-info legend-square" /> and the bench <span className="table-secondary legend-square" />
          .
        </p>
      ) : null}
            ...
            <div className="form-check mt-2">
              <input
                ...
                onChange={async () => {
                  ...
                  await toWorker('main', 'updateKeepRosterSorted', tid, !keepRosterSorted)
                }}
              />
