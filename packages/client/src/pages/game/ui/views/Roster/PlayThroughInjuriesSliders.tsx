      ...
      <input
        ...
        onChange={async (event) => {
          ...
          if (!Number.isNaN(parsed)) {
            setValue(parsed)
            await toWorker('main', 'updatePlayThroughInjuries', tid, parsed, playoffs)
          }
        }}
      />
      <div className="mt-1">
    ...
    <div className="play-through-injuries">
      <div className="d-flex align-items-center">
        ...
        {expanded ? (
          <HelpPopover className="ml-1" title="Play Through Injuries">
            <p>
              This allows you to determine when players should play through minor injuries. You can set the cutoff
              separately for the regular season and playoffs.
            </p>
            <p>
              The more games remaining on a player's injury, the worse he will play. So if a player comes back at 90%
              performance and plays every day until he's healthy, he will gradually improve each game until he reaches
              100%.
            </p>
            <p>
              Additionally, the injury rate is 50% higher when playing through an injury, which includes the possibility
              of a player either reaggravating his current injury or getting a new injury.
            </p>
          </HelpPopover>
        ) : null}
      </div>
      <AnimatePresence initial={false}>
        {expanded ? (
          ...
          >
            <Slider className="mb-3" initialValue={t.playThroughInjuries[0]} tid={t.tid} />
