          ...
          <div>
            <p>
              <span className={champ.tid === userTid ? 'table-info' : undefined}>
                <b>
                  <a href={helpers.leagueUrl(['roster', `${champ.seasonAttrs.abbrev}_${champ.tid}`, season])}>
            ...
            <p>
              {AWARD_NAMES.finalsMvp}: <Winner award={awards.finalsMvp} finals season={season} userTid={userTid} />
            </p>
          </div>
        ) : (
          <p>???</p>
