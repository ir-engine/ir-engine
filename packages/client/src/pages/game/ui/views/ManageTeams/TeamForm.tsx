...
const TeamForm = ({
  ...
  classNamesCol: [string, string, string, string, string, string, string, string, string, string]
  ...
  handleInputChange: (field: string, event: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void
  hideStatus?: boolean
    ...
    <>
      ...
      <div className={classNamesCol[1]}>
        <div className="form-group">
          ...
          <input type="text" className="form-control" onChange={(e) => handleInputChange('name', e)} value={t.name} />
        </div>
      </div>
      ...
      <div className={classNamesCol[3]}>
        <div className="form-group">
          ...
          <select className="form-control" onChange={(e) => handleInputChange('did', e)} value={t.did}>
