  ...
  return (
    <div className="row">
      ...
      >
        ...
        {errorMessage ? <p className="text-danger mt-2 mb-0">{errorMessage}</p> : null}
      </form>
      <div className="col-md-6">
        <p>There are many variables available for the GOAT formula, for award counts and stats.</p>
        ...
        <details className="mb-3">
          ...
          <p>
            The above variables all are career totals. If you want something besides career totals, you can put any of
            these suffixes at the end of a stat, such as <code>{exampleStat}PerGame</code>.
          </p>
          <ul className="list-unstyled">
            ...
            <li>
              <code>PeakPerGame</code> - per-game value of stat's single season peak
            </li>
          </ul>
          <p>
            Seasons with very few games played are ignored for the <code>Peak</code> and <code>PeakPerGame</code>{' '}
            variables, and careers with very few games played are ignored for the career total variables.
          </p>
        </details>
      </div>
    </div>
