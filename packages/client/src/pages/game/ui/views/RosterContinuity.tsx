...
const RosterContinuity = ({ abbrevs, season, seasons, userAbbrev }: View<'rosterContinuity'>) => {
  useTitleBar({
  ...
  return (
    <>
      <p>
        Each cell in the table shows the percentage of minutes played that season by players who were on the same team
        the previous season.
      </p>
