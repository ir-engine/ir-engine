...
const Options = (props: View<'globalSettings'>) => {
  ...
  const handleChange = (name: string) => (event: ChangeEvent<HTMLSelectElement | HTMLTextAreaElement>) => {
      ...
      <form onSubmit={handleFormSubmit}>
        <div className="row">
          ...
          <div className="col-sm-3 col-6 form-group">
            ...
            <select id="options-units" className="form-control" onChange={handleChange('units')} value={state.units}>
              <option value="default">Auto</option>
