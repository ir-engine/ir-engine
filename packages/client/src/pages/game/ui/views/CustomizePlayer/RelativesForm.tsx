...
const RelativesForm = ({
  ...
  const handleRelativesChange = (index: number, field: 'pid' | 'type' | 'add' | 'delete', event?: any) => {
    if (field === 'delete') {
              ...
              {i === 0 ? (
                <label>
                  ...
                  <HelpPopover title="Player ID number">
                    ...
                    <p>
                      To find a player ID number, go to the player page for that player and look at the end of the URL.
                      For instance, if the URL is https://{WEBSITE_PLAY}/l/19/player/6937, then the player ID number is
                      6937.
                    </p>
                    <p>
                      Ideally this would be a search box that would automatically find the ID number when you type in a
