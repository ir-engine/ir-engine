...
export const instanceConnectionReducer = (_, action: InstanceConnectionActionType) => {
  Promise.resolve().then(() => instanceConnectionReceptor(action))
...
export const useInstanceConnectionState = () => useState(state)
