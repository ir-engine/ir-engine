...
class GameSim {
	...
	getPossessionOutcome(possessionLength: number) {
		...
		if (intentionalFoul) {
			// HACK! Add some time back on the clock. BE CAREFUL ABOUT CHANGING STUFF BELOW THIS IN THIS FUNCTION, IT MAY DEPEND ON THIS. Like anything reading this.t or intentionalFoul.
