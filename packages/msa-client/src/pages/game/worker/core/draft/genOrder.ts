...
const TIEBREAKER_AFTER_FIRST_ROUND = "swap";
...
const genOrder = async (
	...
	for (let roundIndex = 1; roundIndex < teamsByRound.length; roundIndex++) {
		...
		// Handle tiebreakers for the 2nd+ round (1st is already done by getTeamsByRound, but 2nd can't be done until now because it depends on lottery results for basketball)
