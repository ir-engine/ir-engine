...
const connectIndexedDB = async <DBTypes>({
	...
	const quotaErrorMessage = `browser isn't letting the game store any more data! Clearing space elsewhere on your hard drive might help. <a href="https://${WEBSITE_ROOT}/manual/debugging/quota-errors/"><b>Read this for more info.</b></a>`;
