...
const footerLinks = [
	...
	{
		url: "https://bbgm.com/blog/",
		title: "Blog",
	},
	{
		url: "https://bbgm.com/contact/",
		title: "Contact",
	},
	{
		url: "https://bbgm.com/privacy/",
		title: "Privacy",
	},
	{
		url: "https://github.com/lagunalabsio/bbgm",
		title: "GitHub",
	},
	{
		...
		<footer className="footer-wrapper mt-auto" id="main-footer">
			...
			>
				...
				>
					<img
						alt=""
						src={`https://bbgm.com/files/logo-basketball.png`}
						style={{
							maxHeight: "100%",
							maxWidth: "100%",
						}}
