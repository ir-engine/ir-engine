...
const getTeamInfos = (
	...
	return teams.map(t => {
		...
		const info: {
			...
			imgURL: `/src/ui/assets/src/ui/assets/img/logos-primary/${actualAbbrev}.svg`,
		};

		if (!noSmallLogo.includes(actualAbbrev)) {
			info.imgURLSmall = `/src/ui/assets/src/ui/assets/img/logos-secondary/${actualAbbrev}.svg`;
		}
