...
import { XRAnchorSystemState } from '../../src/xr/XRAnchorSystem'
...
export async function mockEmulatedXREngine() {
  ...
  getMutableState(XRAnchorSystemState).originAnchorEntity.set(getState(ReferenceSpaceState).originEntity)
}
