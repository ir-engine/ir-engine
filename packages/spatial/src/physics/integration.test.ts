...
import { WebGLRendererSystem } from '../SpatialModule'
...
import { TransformDirtyUpdateSystem, TransformSystem } from '../transform/systems/TransformSystem'
...
describe('Integration : PhysicsSystem + PhysicsPreTransformSystem + TransformSystem', () => {
  const execute = {
    ...
    webglRendererSystem: SystemDefinitions.get(WebGLRendererSystem)!.execute // with: PresentationSystemGroup
  }
  ...
  describe('Category 1 ', () => {
    ...
    it.only("should commit pose modifications generated by the Physics into the entity's TransformComponent data", () => {
