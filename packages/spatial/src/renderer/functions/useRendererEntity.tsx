...
import { Entity, UndefinedEntity, getOptionalComponent, useOptionalComponent, useQuery } from '@ir-engine/ecs'
...
export function useRendererEntity(entity: Entity) {
  ...
  useImmediateEffect(() => {
    ...
    const ParentSubReactor = (props: { entity: Entity }) => {
      ...
      const matchesQuery = renderers.find(
        (r) => getOptionalComponent(r, RendererComponent)?.scenes.includes(props.entity)
      )
