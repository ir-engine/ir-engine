...
import { Easing } from '@ir-engine/ecs/src/Easing'
...
TransformComponent.setTransition(entity, 'position', {
  target: Vector3_One,
  easing: Easing.elastic.inOut
})

TransformComponent.setTransition(entity, 'position.x', {
  target: 10,
  easing: Easing.elastic.inOut
})
