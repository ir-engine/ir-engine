...
//
  ...
  fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<s32>(arg0) });
  return;
}
  ...
  auto res = fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<f64>(arg0) });
  return std::bit_cast<u32>(coerceToNumber<s32>(res));
}
  ...
  fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<s32>(arg0) }, jsi::Value { (double)std::bit_cast<s32>(arg1) });
  return;
}
  ...
  auto res = fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<s32>(arg0) });
  return std::bit_cast<u32>(coerceToNumber<s32>(res));
}
  ...
  auto res = fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<s32>(arg0) }, jsi::Value { (double)std::bit_cast<s32>(arg1) }, jsi::Value { (double)std::bit_cast<s32>(arg2) });
  return std::bit_cast<u32>(coerceToNumber<s32>(res));
}
  ...
  auto res = fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<s32>(arg0) }, jsi::Value { (double)std::bit_cast<s32>(arg1) }, jsi::Value { (double)std::bit_cast<s32>(arg2) }, jsi::Value { (double)std::bit_cast<s32>(arg3) });
  return std::bit_cast<u32>(coerceToNumber<s32>(res));
}
  ...
  auto res = fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<s32>(arg0) }, jsi::Value { (double)std::bit_cast<s32>(arg1) }, jsi::Value { (double)std::bit_cast<s32>(arg2) }, jsi::Value { (double)std::bit_cast<s32>(arg3) }, jsi::Value { (double)std::bit_cast<s32>(arg4) });
  return std::bit_cast<u32>(coerceToNumber<s32>(res));
}
  ...
  fn.call(ctx->rt, jsi::Value { (double)std::bit_cast<s32>(arg0) }, jsi::Value { (double)std::bit_cast<s32>(arg1) }, jsi::Value { (double)std::bit_cast<s32>(arg2) });
  return;
}
