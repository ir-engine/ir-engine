...
const LocationMenu = ({ changeActiveLocation }) => {
    ...
    const tableHeaders = [
        ...
        { id: 'maxUsersPerInstance', numeric: true, disablePadding: false, label: t('user:usermenu.locationTable.col-maxuser') },
    ];
    ...
    return (
        <div className={styles.menuPanel}>
			<section className={styles.locationPanel}>
                ...
                {!locationDetails
                    ?   <section>
                        {t('user:usermenu.locationTable.loading')}
                    </section>
                    :   <>
