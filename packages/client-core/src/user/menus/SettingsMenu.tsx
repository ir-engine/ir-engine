...
export default function SettingsMenu() {
  ...
  return (
    <div className="absolute z-50 h-fit max-h-[60vh] min-h-[50vh] w-[50vw] min-w-[720px] max-w-2xl animate-expandModal overflow-y-auto rounded-2xl bg-[#CDCDCD] p-10 text-[#616161] will-change-transform">
