...
const ProfileMenu = ({ hideLogin, onClose }: Props): JSX.Element => {
  ...
  return (
    <div className="absolute z-50 h-fit max-h-[60vh] w-[50vw] min-w-[720px] max-w-2xl animate-expandModal overflow-y-auto rounded-2xl bg-surface-1 p-10 will-change-transform">
