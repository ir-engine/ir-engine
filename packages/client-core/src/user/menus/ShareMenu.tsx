...
const ShareMenu = (): JSX.Element => {
  ...
  const iframeString = `<iframe src="${window.location.origin + window.location.pathname}" height="100%" width="100%" allow="camera 'src'; microphone 'src';xr-spatial-tracking" style="pointer-events:all;user-select:none;border:none;"></iframe>`
