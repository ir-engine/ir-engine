...
import { AttachFile, PhotoCamera, Send } from '@material-ui/icons'
        ...
        <div className={classes.selfEnd}>
          <div className={classes.dFlex}>
            <div className={`${classes.bgInfo} ${classes.mx2}`}>
              <p>
                You can also head to chrome://extensions and click “Update extensions now” if you’d like to get the new
                version today.
              </p>
            </div>
            <Avatar src="./Avatar.png" />
