...
export const ARPlacement = () => {
  ...
  return  <div style={{ top: inPlacementMode ? '50%' : '12px'}} className={`${styles.drawerBox} ${topShelfStyle}`}>
    <button
      type="button"
      id="UserXR"
    ...
    >
      <LocationSearchingIcon /><div>{inPlacementMode ? t('common:ar.done') : t('common:ar.placeScene')}</div>
    </button>
  </div>
}
