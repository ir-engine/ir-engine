...
const ClapHands = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 21 23" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
const ForwardRef = forwardRef(ClapHands)
