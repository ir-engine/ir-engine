import { TheFeedsFires } from '../../../../../server-core/src/socialmedia/feeds-fires/feeds-fires.class'
/**
...
export const theFeedsFiresReducer = (_, action: TheFeedsFiresActionType) => {
  Promise.resolve().then(() => theFeedsFiresReceptor(action))
  return state.attach(Downgraded).value
}

const theFeedsFiresReceptor = (action: TheFeedsFiresActionType): any => {
  state.batch((s) => {
    switch (action.type) {
