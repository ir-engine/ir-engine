                ...
                <Fade in={props.open}>
                    <div className={classNames({
                        ...
                        <div className={styles['modal-header']}>
                            ...
                            <div className={styles['title']}>{contentPack.name} (v{contentPack.data?.version})</div>
                            <IconButton
                                aria-label="close"
                            ...
                            <div className={styles['avatars-container']}>
                                ...
                                <div className={styles['container']}>
                                    { contentPack.data?.avatars?.map(avatar => {
                                        return <div key={avatar.name} className={styles['avatar']}>
                            ...
                            <div className={styles['scenes-container']}>
                                ...
                                <div className={styles['container']}>
                                    { contentPack.data?.scenes?.map(scene => {
                                        return <div key={scene.name} className={styles['scene']}>
