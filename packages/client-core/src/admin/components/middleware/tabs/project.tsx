...
const ProjectTab = forwardRef(({ open }: { open: boolean }, ref: React.MutableRefObject<HTMLDivElement>) => {
  ...
  return (
    <Accordion
      title={t('admin:components.middleware.project.header')}
      subtitle={t('admin:components.middleware.project.subtitle')}
      ...
      {settings?.length > 0 ? (
        <>
          ...
          <div className="mb-3 grid grid-cols-8 gap-2">
            ...
            >
              {t('admin:components.middleware.project.clear')}
            </Button>
            <Button
              size="small"
              className="col-span-1"
            ...
            >
              {t('admin:components.middleware.project.submit')}
            </Button>
          </div>
        </>
      ) : (
        <Text component="h3" className="text-red-700">
          {t('admin:components.middleware.project.noSettingsMessage')}
        </Text>
      )}
