...
export default async function AdminSystem(world: World) {
  ...
  const instancesRetrievedQueue = createActionQueue(AdminInstanceActions.instancesRetrievedAction.matches)
  const instanceRemovedQueue = createActionQueue(AdminInstanceActions.instanceRemovedAction.matches)
