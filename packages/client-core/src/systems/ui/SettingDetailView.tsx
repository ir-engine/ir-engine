...
const SettingDetailView = () => {
  ...
  return (
    <div style={styles.container as {}} xr-layer="true">
      <div style={styles.settingView as {}} xr-layer="true">
        <section style={styles.audioSection as {}} xr-layer="true">
          <h4 style={styles.title as {}} xr-layer="true">
            {t('user:usermenu.setting.audio')}
          </h4>
          <div style={styles.sectionRow as {}} xr-layer="true">
            <span style={styles.iconSpan as {}} xr-layer="true">
              <svg style={styles.iconSvg as {}} focusable="false" aria-hidden="true" viewBox="0 0 24 24">
                <path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"></path>
              </svg>
            </span>
            <span style={styles.label as {}} xr-layer="true">
        ...
        <section style={styles.graphicsSection as {}} xr-layer="true">
          <h4 style={styles.title as {}} xr-layer="true">
          ...
          <div style={styles.graphicsCheckBoxRow as {}} xr-layer="true">
            <label style={styles.checkBoxRow as {}} xr-layer="true">
              <span
                xr-layer="true"
              ...
              <span style={styles.checkBoxLabel as {}} xr-layer="true">
          ...
          <div style={styles.automaticContainer as {}} xr-layer="true">
            <label style={styles.automaticRow as {}} xr-layer="true">
              <span style={styles.automaticCheckBoxSpan as {}} xr-layer="true">
                <input
                  style={styles.checkBoxInput as {}}
                  type="checkbox"
                  xr-layer="true"
