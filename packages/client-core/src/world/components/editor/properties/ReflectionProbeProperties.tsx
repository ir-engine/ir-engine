...
import { ReflectionProbeRefreshTypes, ReflectionProbeTypes } from "../../../../../../engine/src/editor/nodes/ReflectionProbeNode";
...
export const  ReflectionProbeProperties =(props:ReflectionProbePropertyEditorProps)=>{
    ...
    switch(props.element.type){
        case ReflectionPropertyTypes.Boolean:
            renderVal= <BooleanInput value={getPropertyValue(propertyName)} onChange={(id)=>onChangeProperty(id,propertyName)}/>;
            break;
        ...
        case ReflectionPropertyTypes.ReflectionProbeType:
            /* @ts-ignore */
            renderVal=<SelectInput options={reflectionProbeSelectTypes} onChange={(id)=>{onChangeProperty(id,propertyName);}} value={getPropertyValue(propertyName)} />;
            break;

        case ReflectionPropertyTypes.RefreshMode:
            /* @ts-ignore */
            renderVal=<SelectInput options={reflectionProbeRefreshSelectTypes} onChange={(id)=>{onChangeProperty(id,propertyName);}} value={getPropertyValue(propertyName)} />;
            break;

        case ReflectionPropertyTypes.Resolution:
            /* @ts-ignore */
            renderVal=<SelectInput options={reflectionResolutionTypes} onChange={(id)=>{onChangeProperty(id,propertyName);}} value={getPropertyValue(propertyName)} />;
            break;
