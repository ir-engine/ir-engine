...
export default function ProjectTab({ selectedTab }: { selectedTab: StateMethods<'projects' | 'buildStatus'> }) {
      ...
      <div className="mb-4 flex justify-between gap-2">
        <div className="flex gap-2">
          <div className="flex items-center border-b border-b-blue-400">
            <span className="p-3 text-sm">{t('admin:components.common.all')}</span>
          </div>
          <div className="flex items-center border-b border-b-transparent transition-all hover:border-b-blue-400">
            <button onClick={() => selectedTab.set('buildStatus')} className="p-3 text-sm">
