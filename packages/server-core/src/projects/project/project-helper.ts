...
export const removeProjectUpdateJob = async (app: Application, projectName: string): Promise<void> => {
  try {
    if (app.k8BatchClient) await app.k8BatchClient.deleteNamespacedCronJob(`${projectName}-auto-update`, 'default')
  } catch (err) {
