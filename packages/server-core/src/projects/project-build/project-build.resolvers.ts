...
export const projectBuildPatchResolver = resolve<ProjectBuildType, HookContext>({})

export const projectBuildQueryResolver = resolve<ProjectBuildQuery, HookContext>({})
