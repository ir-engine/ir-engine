import { AVATAR_FILE_ALLOWED_EXTENSIONS, MIN_AVATAR_FILE_SIZE, MAX_AVATAR_FILE_SIZE, MIN_THUMBNAIL_FILE_SIZE, MAX_THUMBNAIL_FILE_SIZE } from '@xr3ngine/common/src/constants/AvatarConstants';
