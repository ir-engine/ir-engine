import { Application } from '../../../server/src/declarations';

// Types
import ChannelType from './networking/channel-type/channel-type.service';
...
// Objects
import Attribution from './media/attribution/attribution.service';
...
import License from './media/license/license.service';
import GameserverSubdomainProvision from './networking/gameserver-subdomain-provision/gameserver-subdomain-provision.service';
...
import Project from './world/project/project.service';
import RtcPorts from './networking/rtc-ports/rtc-ports.service';
import Seat from './payments/seat/seat.service';
...
import PartyUser from './user/party-user/party-user.service';
...
import SMS from './user/sms/sms.service';
import Tag from './world/tag/tag.service';
import Upload from './media/upload/upload.service';
import UploadPresigned from './upload-presigned/upload-presigned.service';
import Video from './video/video.service';
import Subscription from './payments/subscription/subscription.service';
...
// Editor
import MediaSearch from './world/media-search/media-search.service';
import Meta from './world/meta/meta.service';
