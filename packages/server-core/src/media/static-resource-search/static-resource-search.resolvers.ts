...
export const staticResourceSearchResultResolver = resolve<StaticResourceSearchResultType, HookContext<Application>>({
  ...
  url: virtual(async (value, obj, context) => {
    // URL should already be generated by the service, just return it
    return value
  }),

  thumbnailURL: virtual(async (value, obj, context) => {
    // Thumbnail URL should already be generated by the service, just return it
    return value
  }),
  ...
  searchScore: virtual(async (value) => {
