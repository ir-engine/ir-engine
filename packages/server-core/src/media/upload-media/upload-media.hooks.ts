...
import addThumbnailFileId from '@xr3ngine/server-core/src/hooks/add-thumbnail-file-id';
...
import createOwnedFile from '@xr3ngine/server-core/src/hooks/create-owned-file';
import logRequest from '@xr3ngine/server-core/src/hooks/log-request';
...
import removePreviousThumbnail from '@xr3ngine/server-core/src/hooks/remove-previous-thumbnail';
import setResponseStatus from '@xr3ngine/server-core/src/hooks/set-response-status-code';
