...
import partyPermissionAuthenticate from '@standardcreative/server-core/src/hooks/party-permission-authenticate'
import partyUserPermissionAuthenticate from '@standardcreative/server-core/src/hooks/party-user-permission-authenticate'
import { HookContext } from '@feathersjs/feathers'
import { disallow, iff, isProvider } from 'feathers-hooks-common'
import unsetSelfPartyOwner from '@standardcreative/server-core/src/hooks/unset-self-party-owner'
import checkPartyInstanceSize from '@standardcreative/server-core/src/hooks/check-party-instance-size'
