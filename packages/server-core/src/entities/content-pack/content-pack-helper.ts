...
export async function populateScene(
  ...
  for (const [key, value] of Object.entries(scene.entities) as [string, any]) {
    ...
    All branches
    dev
    Updated 2 hours ago by speigg
    Default
    renovate/pin-dependencies
    Updated 2 hours ago by renovate-bot
    0
    1
    #3723  Open
    refactor-realitypacks-projects-scenes
    Updated 2 hours ago by HexaField
    11
    5
    #3743  Draft
    hookstateTypingAdmin
    Deleted just now by HexaField
    ￼Restore
    cleanup-state
    Deleted just now by HexaField
    ￼Restore
    renovate/esbuild-0.x
    Updated 4 hours ago by renovate-bot
    13
    1
    #3746  Open
    renovate/vite-plugin-optimize-persist-0.x
    Updated 5 hours ago by renovate-bot
    13
    1
    #3744  Open
    move-avatar-bugfixes
    Updated 5 hours ago by NateTheGreatt
    13
    1
    #3745  Open
    Add-Map-README
    Updated 7 hours ago by patreeceeo
    18
    3
    #3741  Draft
    renovate/socket.io-packages
    Updated 7 hours ago by renovate-bot
    14
    1
    #3739  Open
    mappa1-warp-ui
    Updated 9 hours ago by patreeceeo
    30
    229
    #3713  Open
    renovate/internal-ip-7.x
    Updated 14 hours ago by renovate-bot
    34
    1
    #3736  Open
    renovate/mysql2-2.x
    Updated 22 hours ago by renovate-bot
    36
    1
    #3717  Open
    renovate/i18next-21.x
    Updated 23 hours ago by renovate-bot
    36
    1
    #3729  Open
    FileBrowser
    Updated 2 days ago by Abhishek-Pathak-Here
    133
    31
    #3622  Draft
    rondoor-shopify-node
    Updated 2 days ago by rondoor124
    132
    1
     New pull request
    ￼
    avatar_networking_update
    Updated 2 days ago by mohsenheydari
    65
    4
    #3716  Merged
    ￼
