...
{{- define "etherealengine.builder.name" -}}
...
{{- define "etherealengine.builder.fullname" -}}
...
Common labels
*/}}
{{- define "etherealengine.builder.labels" -}}
helm.sh/chart: {{ include "etherealengine.chart" . }}
{{ include "etherealengine.builder.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "etherealengine.builder.selectorLabels" -}}
app.kubernetes.io/name: {{ include "etherealengine.builder.name" . }}
...
*/}}
{{- define "etherealengine.builder.serviceAccountName" -}}
{{- if .Values.builder.serviceAccount.create -}}
    {{ default (include "etherealengine.builder.fullname" .) .Values.builder.serviceAccount.name }}
{{- else -}}
