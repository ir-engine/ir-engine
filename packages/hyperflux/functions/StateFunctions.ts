...
export function defineState<S, DefintionExtras = unknown>(definition: StateDefinition<S> & DefintionExtras) {
  ...
  return definition as StateDefinition<S> & { _TYPE: S } & DefintionExtras
}
