...
Defined in: [packages/client-core/src/user/reducers/auth/selector.ts:4](https://github.com/xr3ngine/xr3ngine/blob/7e8e151f1/packages/client-core/src/user/reducers/auth/selector.ts#L4)
