...
Defined in: [packages/server-core/src/social/location-type/location-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/673ad6a5f/packages/server-core/src/social/location-type/location-type.class.ts#L10)
