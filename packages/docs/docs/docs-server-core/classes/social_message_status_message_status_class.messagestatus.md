---
id: "social_message_status_message_status_class.messagestatus"
...
[social/message-status/message-status.class](../modules/social_message_status_message_status_class.md).MessageStatus
...
\+ **new MessageStatus**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*MessageStatus*](social_message_status_message_status_class.messagestatus.md)
...
**Returns:** [*MessageStatus*](social_message_status_message_status_class.messagestatus.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/social/message-status/message-status.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/673ad6a5f/packages/server-core/src/social/message-status/message-status.class.ts#L10)
