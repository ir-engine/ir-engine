...
Defined in: [packages/server-core/src/social/message-status/message-status.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/server-core/src/social/message-status/message-status.class.ts#L10)
