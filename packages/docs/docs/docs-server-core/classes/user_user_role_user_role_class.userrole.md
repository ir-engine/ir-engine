...
Defined in: [packages/server-core/src/user/user-role/user-role.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/65dfcf39a/packages/server-core/src/user/user-role/user-role.class.ts#L10)
