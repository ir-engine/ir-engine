...
Defined in: [packages/server-core/src/user/user-role/user-role.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/673ad6a5f/packages/server-core/src/user/user-role/user-role.class.ts#L10)
