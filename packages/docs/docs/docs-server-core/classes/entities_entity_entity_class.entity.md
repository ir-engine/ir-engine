...
Defined in: [packages/server-core/src/entities/entity/entity.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/673ad6a5f/packages/server-core/src/entities/entity/entity.class.ts#L10)
