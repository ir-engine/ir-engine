---
id: "networking_rtc_ports_rtc_ports_class.rtcports"
...
[networking/rtc-ports/rtc-ports.class](../modules/networking_rtc_ports_rtc_ports_class.md).RtcPorts
...
\+ **new RtcPorts**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*RtcPorts*](networking_rtc_ports_rtc_ports_class.rtcports.md)
...
**Returns:** [*RtcPorts*](networking_rtc_ports_rtc_ports_class.rtcports.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/networking/rtc-ports/rtc-ports.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7e8e151f1/packages/server-core/src/networking/rtc-ports/rtc-ports.class.ts#L10)
