...
Defined in: [packages/server-core/src/social/channel-type/channel-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/a16a45d7e/packages/server-core/src/social/channel-type/channel-type.class.ts#L10)
