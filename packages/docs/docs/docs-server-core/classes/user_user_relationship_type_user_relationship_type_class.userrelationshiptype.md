---
id: "user_user_relationship_type_user_relationship_type_class.userrelationshiptype"
...
[user/user-relationship-type/user-relationship-type.class](../modules/user_user_relationship_type_user_relationship_type_class.md).UserRelationshipType
...
\+ **new UserRelationshipType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*UserRelationshipType*](user_user_relationship_type_user_relationship_type_class.userrelationshiptype.md)
...
**Returns:** [*UserRelationshipType*](user_user_relationship_type_user_relationship_type_class.userrelationshiptype.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/user/user-relationship-type/user-relationship-type.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/7e8e151f1/packages/server-core/src/user/user-relationship-type/user-relationship-type.class.ts#L11)
