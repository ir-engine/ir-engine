...
Defined in: [packages/server-core/src/social/group-user/group-user.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/a16a45d7e/packages/server-core/src/social/group-user/group-user.class.ts#L11)
