...
Defined in: [packages/server-core/src/social/group-user/group-user.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/server-core/src/social/group-user/group-user.class.ts#L11)
