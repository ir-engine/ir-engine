...
[user/user/user.class](../modules/user_user_user_class.md).User
...
\+ **new User**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*User*](user_user_user_class.user.md)
...
**Returns:** [*User*](user_user_user_class.user.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/user/user/user.class.ts:16](https://github.com/xr3ngine/xr3ngine/blob/a16a45d7e/packages/server-core/src/user/user/user.class.ts#L16)
...
Defined in: [packages/server-core/src/user/user/user.class.ts:15](https://github.com/xr3ngine/xr3ngine/blob/a16a45d7e/packages/server-core/src/user/user/user.class.ts#L15)
...
Defined in: [packages/server-core/src/user/user/user.class.ts:30](https://github.com/xr3ngine/xr3ngine/blob/a16a45d7e/packages/server-core/src/user/user/user.class.ts#L30)
