...
Defined in: [packages/server-core/src/social/location-settings/location-settings.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/65dfcf39a/packages/server-core/src/social/location-settings/location-settings.class.ts#L10)
