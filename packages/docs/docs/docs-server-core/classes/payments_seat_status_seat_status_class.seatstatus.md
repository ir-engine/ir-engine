...
Defined in: [packages/server-core/src/payments/seat-status/seat-status.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/77d12cea0/packages/server-core/src/payments/seat-status/seat-status.class.ts#L10)
