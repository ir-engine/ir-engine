---
id: "entities_collection_type_collection_type_class.collectiontype"
...
[entities/collection-type/collection-type.class](../modules/entities_collection_type_collection_type_class.md).CollectionType
...
\+ **new CollectionType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*CollectionType*](entities_collection_type_collection_type_class.collectiontype.md)
...
**Returns:** [*CollectionType*](entities_collection_type_collection_type_class.collectiontype.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/entities/collection-type/collection-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/65dfcf39a/packages/server-core/src/entities/collection-type/collection-type.class.ts#L10)
