...
Defined in: [packages/server-core/src/payments/subscription-level/subscription-level.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/65dfcf39a/packages/server-core/src/payments/subscription-level/subscription-level.class.ts#L10)
