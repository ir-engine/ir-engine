---
id: "social_invite_type_invite_type_class.invitetype"
...
[social/invite-type/invite-type.class](../modules/social_invite_type_invite_type_class.md).InviteType
...
\+ **new InviteType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*InviteType*](social_invite_type_invite_type_class.invitetype.md)
...
**Returns:** [*InviteType*](social_invite_type_invite_type_class.invitetype.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/social/invite-type/invite-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/77d12cea0/packages/server-core/src/social/invite-type/invite-type.class.ts#L10)
