...
Defined in: [packages/server-core/src/social/invite-type/invite-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/65dfcf39a/packages/server-core/src/social/invite-type/invite-type.class.ts#L10)
