...
Defined in: [packages/server-core/src/user/user-settings/user-settings.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/2d83606b6/packages/server-core/src/user/user-settings/user-settings.class.ts#L10)
