---
id: "user_user_settings_user_settings_class.usersettings"
...
[user/user-settings/user-settings.class](../modules/user_user_settings_user_settings_class.md).UserSettings
...
\+ **new UserSettings**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*UserSettings*](user_user_settings_user_settings_class.usersettings.md)
...
**Returns:** [*UserSettings*](user_user_settings_user_settings_class.usersettings.md)

Overrides: void

Defined in: [packages/server-core/src/user/user-settings/user-settings.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/server-core/src/user/user-settings/user-settings.class.ts#L10)
