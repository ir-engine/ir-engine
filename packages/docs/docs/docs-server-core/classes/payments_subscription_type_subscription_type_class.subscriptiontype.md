---
id: "payments_subscription_type_subscription_type_class.subscriptiontype"
...
[payments/subscription-type/subscription-type.class](../modules/payments_subscription_type_subscription_type_class.md).SubscriptionType
...
\+ **new SubscriptionType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*SubscriptionType*](payments_subscription_type_subscription_type_class.subscriptiontype.md)
...
**Returns:** [*SubscriptionType*](payments_subscription_type_subscription_type_class.subscriptiontype.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/payments/subscription-type/subscription-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7e8e151f1/packages/server-core/src/payments/subscription-type/subscription-type.class.ts#L10)
