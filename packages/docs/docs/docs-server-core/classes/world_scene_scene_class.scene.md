...
Defined in: [packages/server-core/src/world/scene/scene.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/2d83606b6/packages/server-core/src/world/scene/scene.class.ts#L9)
