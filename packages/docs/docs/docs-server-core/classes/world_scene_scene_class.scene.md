---
id: "world_scene_scene_class.scene"
title: "Class: Scene"
sidebar_label: "Scene"
...
[world/scene/scene.class](../modules/world_scene_scene_class.md).Scene
...
\+ **new Scene**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*Scene*](world_scene_scene_class.scene.md)
...
**Returns:** [*Scene*](world_scene_scene_class.scene.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/world/scene/scene.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/65dfcf39a/packages/server-core/src/world/scene/scene.class.ts#L9)
