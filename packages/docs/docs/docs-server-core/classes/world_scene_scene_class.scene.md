...
Defined in: [packages/server-core/src/world/scene/scene.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/server-core/src/world/scene/scene.class.ts#L9)
