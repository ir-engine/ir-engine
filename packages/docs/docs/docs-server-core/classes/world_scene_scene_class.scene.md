...
Defined in: [packages/server-core/src/world/scene/scene.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/a16a45d7e/packages/server-core/src/world/scene/scene.class.ts#L9)
