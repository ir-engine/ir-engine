---
id: "media_static_resource_type_static_resource_type_class.staticresourcetype"
...
[media/static-resource-type/static-resource-type.class](../modules/media_static_resource_type_static_resource_type_class.md).StaticResourceType
...
\+ **new StaticResourceType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: Application): [*StaticResourceType*](media_static_resource_type_static_resource_type_class.staticresourcetype.md)
...
**Returns:** [*StaticResourceType*](media_static_resource_type_static_resource_type_class.staticresourcetype.md)

Overrides: Service.constructor

Defined in: [packages/server-core/src/media/static-resource-type/static-resource-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/77d12cea0/packages/server-core/src/media/static-resource-type/static-resource-type.class.ts#L10)
