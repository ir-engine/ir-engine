...
Defined in: [packages/server-core/src/user/email/email.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/2d83606b6/packages/server-core/src/user/email/email.class.ts#L9)
