...
Defined in: [packages/server-core/src/user/email/email.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/673ad6a5f/packages/server-core/src/user/email/email.class.ts#L9)
