...
Defined in: [packages/server-core/src/user/email/email.ts:1](https://github.com/xr3ngine/xr3ngine/blob/673ad6a5f/packages/server-core/src/user/email/email.ts#L1)
