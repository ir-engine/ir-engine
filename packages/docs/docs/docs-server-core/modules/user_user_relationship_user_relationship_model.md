...
Defined in: [packages/server-core/src/user/user-relationship/user-relationship.model.ts:2](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/server-core/src/user/user-relationship/user-relationship.model.ts#L2)
