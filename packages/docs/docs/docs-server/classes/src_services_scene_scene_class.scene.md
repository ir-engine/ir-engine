---
id: "src_services_scene_scene_class.scene"
title: "Class: Scene"
sidebar_label: "Scene"
...
[src/services/scene/scene.class](../modules/src_services_scene_scene_class.md).Scene
...
\+ **new Scene**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*Scene*](src_services_scene_scene_class.scene.md)
...
**Returns:** [*Scene*](src_services_scene_scene_class.scene.md)

Overrides: void

Defined in: [packages/server/src/services/scene/scene.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/scene/scene.class.ts#L9)
