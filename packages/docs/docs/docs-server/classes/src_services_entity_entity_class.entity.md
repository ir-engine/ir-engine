---
id: "src_services_entity_entity_class.entity"
title: "Class: Entity"
...
[src/services/entity/entity.class](../modules/src_services_entity_entity_class.md).Entity
...
\+ **new Entity**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*Entity*](src_services_entity_entity_class.entity.md)
...
**Returns:** [*Entity*](src_services_entity_entity_class.entity.md)

Overrides: void

Defined in: [packages/server/src/services/entity/entity.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/entity/entity.class.ts#L10)
