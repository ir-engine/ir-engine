---
id: "src_services_user_relationship_type_user_relationship_type_class.userrelationshiptype"
title: "Class: UserRelationshipType"
sidebar_label: "UserRelationshipType"
...
[src/services/user-relationship-type/user-relationship-type.class](../modules/src_services_user_relationship_type_user_relationship_type_class.md).UserRelationshipType
...
\+ **new UserRelationshipType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*UserRelationshipType*](src_services_user_relationship_type_user_relationship_type_class.userrelationshiptype.md)
...
**Returns:** [*UserRelationshipType*](src_services_user_relationship_type_user_relationship_type_class.userrelationshiptype.md)

Overrides: void

Defined in: [packages/server/src/services/user-relationship-type/user-relationship-type.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/user-relationship-type/user-relationship-type.class.ts#L11)
