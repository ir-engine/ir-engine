---
id: "src_services_message_status_message_status_class.messagestatus"
title: "Class: MessageStatus"
sidebar_label: "MessageStatus"
...
[src/services/message-status/message-status.class](../modules/src_services_message_status_message_status_class.md).MessageStatus
...
\+ **new MessageStatus**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*MessageStatus*](src_services_message_status_message_status_class.messagestatus.md)
...
**Returns:** [*MessageStatus*](src_services_message_status_message_status_class.messagestatus.md)

Overrides: void

Defined in: [packages/server/src/services/message-status/message-status.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/message-status/message-status.class.ts#L10)
