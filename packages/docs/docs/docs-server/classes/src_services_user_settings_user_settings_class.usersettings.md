---
id: "src_services_user_settings_user_settings_class.usersettings"
...
[src/services/user-settings/user-settings.class](../modules/src_services_user_settings_user_settings_class.md).UserSettings
...
\+ **new UserSettings**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*UserSettings*](src_services_user_settings_user_settings_class.usersettings.md)
...
**Returns:** [*UserSettings*](src_services_user_settings_user_settings_class.usersettings.md)

Overrides: void

Defined in: [packages/server/src/services/user-settings/user-settings.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/user-settings/user-settings.class.ts#L10)
