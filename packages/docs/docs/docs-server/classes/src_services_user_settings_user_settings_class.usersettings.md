...
Defined in: [packages/server/src/services/user-settings/user-settings.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/user-settings/user-settings.class.ts#L10)
