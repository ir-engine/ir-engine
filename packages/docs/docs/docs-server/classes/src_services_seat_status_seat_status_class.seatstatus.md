---
id: "src_services_seat_status_seat_status_class.seatstatus"
...
[src/services/seat-status/seat-status.class](../modules/src_services_seat_status_seat_status_class.md).SeatStatus
...
\+ **new SeatStatus**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*SeatStatus*](src_services_seat_status_seat_status_class.seatstatus.md)
...
**Returns:** [*SeatStatus*](src_services_seat_status_seat_status_class.seatstatus.md)

Overrides: void

Defined in: [packages/server/src/services/seat-status/seat-status.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/seat-status/seat-status.class.ts#L10)
