...
Defined in: [packages/server/src/services/seat-status/seat-status.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/seat-status/seat-status.class.ts#L10)
