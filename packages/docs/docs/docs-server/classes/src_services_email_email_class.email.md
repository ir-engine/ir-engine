---
id: "src_services_email_email_class.email"
title: "Class: Email"
sidebar_label: "Email"
...
[src/services/email/email.class](../modules/src_services_email_email_class.md).Email
...
\+ **new Email**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*Email*](src_services_email_email_class.email.md)
...
**Returns:** [*Email*](src_services_email_email_class.email.md)

Overrides: void

Defined in: [packages/server/src/services/email/email.class.ts:9](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/email/email.class.ts#L9)
