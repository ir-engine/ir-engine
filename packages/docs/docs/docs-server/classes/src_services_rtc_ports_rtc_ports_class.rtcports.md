---
id: "src_services_rtc_ports_rtc_ports_class.rtcports"
title: "Class: RtcPorts"
sidebar_label: "RtcPorts"
...
[src/services/rtc-ports/rtc-ports.class](../modules/src_services_rtc_ports_rtc_ports_class.md).RtcPorts
...
\+ **new RtcPorts**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*RtcPorts*](src_services_rtc_ports_rtc_ports_class.rtcports.md)
...
**Returns:** [*RtcPorts*](src_services_rtc_ports_rtc_ports_class.rtcports.md)

Overrides: void

Defined in: [packages/server/src/services/rtc-ports/rtc-ports.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/rtc-ports/rtc-ports.class.ts#L10)
