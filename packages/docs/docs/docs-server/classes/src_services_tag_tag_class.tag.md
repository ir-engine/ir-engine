---
id: "src_services_tag_tag_class.tag"
title: "Class: Tag"
sidebar_label: "Tag"
...
[src/services/tag/tag.class](../modules/src_services_tag_tag_class.md).Tag
...
\+ **new Tag**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*Tag*](src_services_tag_tag_class.tag.md)
...
**Returns:** [*Tag*](src_services_tag_tag_class.tag.md)

Overrides: void

Defined in: [packages/server/src/services/tag/tag.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/tag/tag.class.ts#L10)
