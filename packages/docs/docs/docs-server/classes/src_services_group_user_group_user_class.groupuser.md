...
Defined in: [packages/server/src/services/group-user/group-user.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/group-user/group-user.class.ts#L11)
