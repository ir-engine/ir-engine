---
id: "src_services_group_user_group_user_class.groupuser"
...
[src/services/group-user/group-user.class](../modules/src_services_group_user_group_user_class.md).GroupUser
...
\+ **new GroupUser**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*GroupUser*](src_services_group_user_group_user_class.groupuser.md)
...
**Returns:** [*GroupUser*](src_services_group_user_group_user_class.groupuser.md)

Overrides: void

Defined in: [packages/server/src/services/group-user/group-user.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/group-user/group-user.class.ts#L11)
