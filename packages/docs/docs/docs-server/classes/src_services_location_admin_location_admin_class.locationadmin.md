---
id: "src_services_location_admin_location_admin_class.locationadmin"
title: "Class: LocationAdmin"
...
[src/services/location-admin/location-admin.class](../modules/src_services_location_admin_location_admin_class.md).LocationAdmin
...
\+ **new LocationAdmin**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*LocationAdmin*](src_services_location_admin_location_admin_class.locationadmin.md)
...
**Returns:** [*LocationAdmin*](src_services_location_admin_location_admin_class.locationadmin.md)

Overrides: void

Defined in: [packages/server/src/services/location-admin/location-admin.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/location-admin/location-admin.class.ts#L11)
