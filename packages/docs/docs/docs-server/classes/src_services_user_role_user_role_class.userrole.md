---
id: "src_services_user_role_user_role_class.userrole"
title: "Class: UserRole"
...
[src/services/user-role/user-role.class](../modules/src_services_user_role_user_role_class.md).UserRole
...
\+ **new UserRole**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*UserRole*](src_services_user_role_user_role_class.userrole.md)
...
**Returns:** [*UserRole*](src_services_user_role_user_role_class.userrole.md)

Overrides: void

Defined in: [packages/server/src/services/user-role/user-role.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/user-role/user-role.class.ts#L10)
