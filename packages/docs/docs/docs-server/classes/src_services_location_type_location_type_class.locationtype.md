---
id: "src_services_location_type_location_type_class.locationtype"
title: "Class: LocationType"
...
[src/services/location-type/location-type.class](../modules/src_services_location_type_location_type_class.md).LocationType
...
\+ **new LocationType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*LocationType*](src_services_location_type_location_type_class.locationtype.md)
...
**Returns:** [*LocationType*](src_services_location_type_location_type_class.locationtype.md)

Overrides: void

Defined in: [packages/server/src/services/location-type/location-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/location-type/location-type.class.ts#L10)
