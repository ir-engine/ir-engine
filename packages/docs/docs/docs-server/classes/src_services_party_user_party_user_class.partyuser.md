---
id: "src_services_party_user_party_user_class.partyuser"
title: "Class: PartyUser"
sidebar_label: "PartyUser"
...
[src/services/party-user/party-user.class](../modules/src_services_party_user_party_user_class.md).PartyUser
...
\+ **new PartyUser**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*PartyUser*](src_services_party_user_party_user_class.partyuser.md)
...
**Returns:** [*PartyUser*](src_services_party_user_party_user_class.partyuser.md)

Overrides: void

Defined in: [packages/server/src/services/party-user/party-user.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/party-user/party-user.class.ts#L11)
...
Defined in: [packages/server/src/services/party-user/party-user.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/party-user/party-user.class.ts#L10)
