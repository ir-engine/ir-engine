...
Defined in: [packages/server/src/services/party-user/party-user.class.ts:11](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/party-user/party-user.class.ts#L11)
...
Defined in: [packages/server/src/services/party-user/party-user.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/party-user/party-user.class.ts#L10)
