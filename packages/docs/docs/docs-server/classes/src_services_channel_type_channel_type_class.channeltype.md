...
Defined in: [packages/server/src/services/channel-type/channel-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/66a84a950/packages/server/src/services/channel-type/channel-type.class.ts#L10)
