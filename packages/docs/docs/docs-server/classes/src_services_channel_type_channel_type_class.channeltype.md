---
id: "src_services_channel_type_channel_type_class.channeltype"
...
[src/services/channel-type/channel-type.class](../modules/src_services_channel_type_channel_type_class.md).ChannelType
...
\+ **new ChannelType**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*ChannelType*](src_services_channel_type_channel_type_class.channeltype.md)
...
**Returns:** [*ChannelType*](src_services_channel_type_channel_type_class.channeltype.md)

Overrides: void

Defined in: [packages/server/src/services/channel-type/channel-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/channel-type/channel-type.class.ts#L10)
