...
Defined in: [packages/server/src/services/invite-type/invite-type.class.ts:10](https://github.com/xr3ngine/xr3ngine/blob/7650c2bea/packages/server/src/services/invite-type/invite-type.class.ts#L10)
