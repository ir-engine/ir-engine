---
id: "src_services_user_user_class.user"
title: "Class: User"
sidebar_label: "User"
...
[src/services/user/user.class](../modules/src_services_user_user_class.md).User
...
\+ **new User**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*User*](src_services_user_user_class.user.md)
...
**Returns:** [*User*](src_services_user_user_class.user.md)
