---
id: "src_services_invite_invite_class.invite"
title: "Class: Invite"
...
[src/services/invite/invite.class](../modules/src_services_invite_invite_class.md).Invite
...
\+ **new Invite**(`options`: *Partial*<SequelizeServiceOptions\>, `app`: [*Application*](../modules/src_declarations.md#application)): [*Invite*](src_services_invite_invite_class.invite.md)
...
**Returns:** [*Invite*](src_services_invite_invite_class.invite.md)
