---
id: "interaction_components_interactivefocused.interactivefocused"
title: "Class: InteractiveFocused"
sidebar_label: "InteractiveFocused"
custom_edit_url: null
hide_title: true
---

# Class: InteractiveFocused

[interaction/components/InteractiveFocused](../modules/interaction_components_interactivefocused.md).InteractiveFocused

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*InteractiveFocused*](interaction_components_interactivefocused.interactivefocused.md)\>
...
\+ **new InteractiveFocused**(`props?`: *false* \| *Partial*<Omit<[*InteractiveFocused*](interaction_components_interactivefocused.interactivefocused.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*InteractiveFocused*](interaction_components_interactivefocused.interactivefocused.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*InteractiveFocused*](interaction_components_interactivefocused.interactivefocused.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*InteractiveFocused*](interaction_components_interactivefocused.interactivefocused.md)
...
• **interacts**: [*Entity*](ecs_classes_entity.entity.md)

Defined in: [packages/engine/src/interaction/components/InteractiveFocused.ts:6](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/interaction/components/InteractiveFocused.ts#L6)
...
:------ | :------ |
`interacts` | *object* |
`interacts.type` | [*PropType*](../interfaces/ecs_types_types.proptype.md)<unknown, any\> |

Overrides: [Component](ecs_classes_component.component.md).[_schema](ecs_classes_component.component.md#_schema)

Defined in: [packages/engine/src/interaction/components/InteractiveFocused.ts:8](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/interaction/components/InteractiveFocused.ts#L8)
