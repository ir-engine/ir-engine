---
id: "audio_components_positionalaudiocomponent.positionalaudiocomponent"
title: "Class: PositionalAudioComponent"
sidebar_label: "PositionalAudioComponent"
custom_edit_url: null
hide_title: true
---

# Class: PositionalAudioComponent

[audio/components/PositionalAudioComponent](../modules/audio_components_positionalaudiocomponent.md).PositionalAudioComponent

Component wrapper class fro [PositionalAudio](https://threejs.org/docs/index.html#api/en/audio/PositionalAudio) from three.js.

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*PositionalAudioComponent*](audio_components_positionalaudiocomponent.positionalaudiocomponent.md)\>
...
\+ **new PositionalAudioComponent**(`props?`: *false* \| *Partial*<Omit<[*PositionalAudioComponent*](audio_components_positionalaudiocomponent.positionalaudiocomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*PositionalAudioComponent*](audio_components_positionalaudiocomponent.positionalaudiocomponent.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*PositionalAudioComponent*](audio_components_positionalaudiocomponent.positionalaudiocomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*PositionalAudioComponent*](audio_components_positionalaudiocomponent.positionalaudiocomponent.md)
...
Defined in: [packages/engine/src/audio/components/PositionalAudioComponent.ts:8](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/audio/components/PositionalAudioComponent.ts#L8)
