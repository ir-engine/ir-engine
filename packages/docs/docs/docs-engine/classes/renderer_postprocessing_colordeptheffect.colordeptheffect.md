---
id: "renderer_postprocessing_colordeptheffect.colordeptheffect"
title: "Class: ColorDepthEffect"
sidebar_label: "ColorDepthEffect"
custom_edit_url: null
hide_title: true
---

# Class: ColorDepthEffect

[renderer/postprocessing/ColorDepthEffect](../modules/renderer_postprocessing_colordeptheffect.md).ColorDepthEffect
...
\+ **new ColorDepthEffect**(`__namedParameters?`: { `bits`:  ; `blendFunction`:   }): [*ColorDepthEffect*](renderer_postprocessing_colordeptheffect.colordeptheffect.md)
...
`__namedParameters.bits` | - |
`__namedParameters.blendFunction` | - |

**Returns:** [*ColorDepthEffect*](renderer_postprocessing_colordeptheffect.colordeptheffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts:14](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts#L14)
...
Defined in: [packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts:13](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts#L13)
...
Defined in: [packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts:52](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts#L52)
...
Name | Type | Description |
:------ | :------ | :------ |
`bits` | *any* | The new color bit depth.    |

**Returns:** *void*

Defined in: [packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts:67](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/ColorDepthEffect.ts#L67)
