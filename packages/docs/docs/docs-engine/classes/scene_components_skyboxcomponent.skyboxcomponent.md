---
id: "scene_components_skyboxcomponent.skyboxcomponent"
title: "Class: SkyboxComponent"
sidebar_label: "SkyboxComponent"
...
[scene/components/SkyboxComponent](../modules/scene_components_skyboxcomponent.md).SkyboxComponent

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*SkyboxComponent*](scene_components_skyboxcomponent.skyboxcomponent.md)\>
...
\+ **new SkyboxComponent**(`props?`: *false* \| *Partial*<Omit<[*SkyboxComponent*](scene_components_skyboxcomponent.skyboxcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*SkyboxComponent*](scene_components_skyboxcomponent.skyboxcomponent.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*SkyboxComponent*](scene_components_skyboxcomponent.skyboxcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*SkyboxComponent*](scene_components_skyboxcomponent.skyboxcomponent.md)
...
• **value**: [*Sky*](scene_classes_sky.sky.md)

Defined in: [packages/engine/src/scene/components/SkyboxComponent.ts:6](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/scene/components/SkyboxComponent.ts#L6)
