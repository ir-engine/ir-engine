---
id: "audio_components_playsoundeffect.playsoundeffect"
title: "Class: PlaySoundEffect"
sidebar_label: "PlaySoundEffect"
...
[audio/components/PlaySoundEffect](../modules/audio_components_playsoundeffect.md).PlaySoundEffect

Component class for Sound Effects to play.

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*PlaySoundEffect*](audio_components_playsoundeffect.playsoundeffect.md)\>
...
\+ **new PlaySoundEffect**(`props?`: *false* \| *Partial*<Omit<[*PlaySoundEffect*](audio_components_playsoundeffect.playsoundeffect.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*PlaySoundEffect*](audio_components_playsoundeffect.playsoundeffect.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*PlaySoundEffect*](audio_components_playsoundeffect.playsoundeffect.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*PlaySoundEffect*](audio_components_playsoundeffect.playsoundeffect.md)
