---
id: "renderer_postprocessing_noiseeffect.noiseeffect"
title: "Class: NoiseEffect"
sidebar_label: "NoiseEffect"
...
[renderer/postprocessing/NoiseEffect](../modules/renderer_postprocessing_noiseeffect.md).NoiseEffect
...
\+ **new NoiseEffect**(`__namedParameters?`: { `blendFunction`:  ; `premultiply`:   }): [*NoiseEffect*](renderer_postprocessing_noiseeffect.noiseeffect.md)
...
`__namedParameters.premultiply` | - |

**Returns:** [*NoiseEffect*](renderer_postprocessing_noiseeffect.noiseeffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/NoiseEffect.ts:9](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/NoiseEffect.ts#L9)
...
Defined in: [packages/engine/src/renderer/postprocessing/NoiseEffect.ts:30](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/NoiseEffect.ts#L30)

• set **premultiply**(`value`: *any*): *void*
...
Defined in: [packages/engine/src/renderer/postprocessing/NoiseEffect.ts:40](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/NoiseEffect.ts#L40)
