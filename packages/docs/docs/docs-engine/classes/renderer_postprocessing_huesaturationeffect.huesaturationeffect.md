---
id: "renderer_postprocessing_huesaturationeffect.huesaturationeffect"
title: "Class: HueSaturationEffect"
sidebar_label: "HueSaturationEffect"
...
[renderer/postprocessing/HueSaturationEffect](../modules/renderer_postprocessing_huesaturationeffect.md).HueSaturationEffect
...
\+ **new HueSaturationEffect**(`__namedParameters?`: { `blendFunction`:  ; `hue`:  ; `saturation`:   }): [*HueSaturationEffect*](renderer_postprocessing_huesaturationeffect.huesaturationeffect.md)
...
`__namedParameters.hue` | - |
`__namedParameters.saturation` | - |

**Returns:** [*HueSaturationEffect*](renderer_postprocessing_huesaturationeffect.huesaturationeffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/HueSaturationEffect.ts:12](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/HueSaturationEffect.ts#L12)
...
Name | Type | Description |
:------ | :------ | :------ |
`hue` | *any* | The hue in radians.    |

**Returns:** *void*

Defined in: [packages/engine/src/renderer/postprocessing/HueSaturationEffect.ts:43](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/HueSaturationEffect.ts#L43)
