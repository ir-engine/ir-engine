---
id: "transform_components_copytransformcomponent.copytransformcomponent"
title: "Class: CopyTransformComponent"
sidebar_label: "CopyTransformComponent"
custom_edit_url: null
hide_title: true
---

# Class: CopyTransformComponent

[transform/components/CopyTransformComponent](../modules/transform_components_copytransformcomponent.md).CopyTransformComponent

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*CopyTransformComponent*](transform_components_copytransformcomponent.copytransformcomponent.md)\>

  ↳ **CopyTransformComponent**

## Constructors

### constructor

\+ **new CopyTransformComponent**(`props?`: *false* \| *Partial*<Omit<[*CopyTransformComponent*](transform_components_copytransformcomponent.copytransformcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*CopyTransformComponent*](transform_components_copytransformcomponent.copytransformcomponent.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*CopyTransformComponent*](transform_components_copytransformcomponent.copytransformcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*CopyTransformComponent*](transform_components_copytransformcomponent.copytransformcomponent.md)
...
• **input**: [*Entity*](ecs_classes_entity.entity.md)

Defined in: [packages/engine/src/transform/components/CopyTransformComponent.ts:6](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/transform/components/CopyTransformComponent.ts#L6)
