...
Defined in: [packages/engine/src/renderer/postprocessing/passes/SavePass.ts:10](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/passes/SavePass.ts#L10)
