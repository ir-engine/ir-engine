---
id: "debug_systems_debughelperssystem.debughelperssystem"
title: "Class: DebugHelpersSystem"
sidebar_label: "DebugHelpersSystem"
custom_edit_url: null
hide_title: true
---

# Class: DebugHelpersSystem

[debug/systems/DebugHelpersSystem](../modules/debug_systems_debughelperssystem.md).DebugHelpersSystem
...
\+ **new DebugHelpersSystem**(): [*DebugHelpersSystem*](debug_systems_debughelperssystem.debughelperssystem.md)

**Returns:** [*DebugHelpersSystem*](debug_systems_debughelperssystem.debughelperssystem.md)

Overrides: [System](ecs_classes_system.system.md)

Defined in: [packages/engine/src/debug/systems/DebugHelpersSystem.ts:23](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/debug/systems/DebugHelpersSystem.ts#L23)
...
• `Private` **helpersByEntity**: *Record*<ComponentHelpers, Map<[*Entity*](ecs_classes_entity.entity.md), any\>\>

Defined in: [packages/engine/src/debug/systems/DebugHelpersSystem.ts:17](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/debug/systems/DebugHelpersSystem.ts#L17)
...
• **physicsDebugRenderer**: [*CannonDebugRenderer*](debug_systems_cannondebugrenderer.cannondebugrenderer.md)

Defined in: [packages/engine/src/debug/systems/DebugHelpersSystem.ts:18](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/debug/systems/DebugHelpersSystem.ts#L18)
...
Name | Type |
:------ | :------ |
`TOGGLE_AVATAR` | *string* |
`TOGGLE_PHYSICS` | *string* |

Defined in: [packages/engine/src/debug/systems/DebugHelpersSystem.ts:20](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/debug/systems/DebugHelpersSystem.ts#L20)

___

### instance

▪ `Static` **instance**: [*DebugHelpersSystem*](debug_systems_debughelperssystem.debughelperssystem.md)
...
Defined in: [packages/engine/src/debug/systems/DebugHelpersSystem.ts:19](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/debug/systems/DebugHelpersSystem.ts#L19)
...
Defined in: [packages/engine/src/debug/systems/DebugHelpersSystem.ts:49](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/debug/systems/DebugHelpersSystem.ts#L49)
