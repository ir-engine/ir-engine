...
Defined in: [packages/engine/src/input/components/DelegatedInputReceiver.ts:5](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/input/components/DelegatedInputReceiver.ts#L5)
