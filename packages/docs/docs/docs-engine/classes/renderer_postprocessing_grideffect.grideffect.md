---
id: "renderer_postprocessing_grideffect.grideffect"
title: "Class: GridEffect"
sidebar_label: "GridEffect"
...
[renderer/postprocessing/GridEffect](../modules/renderer_postprocessing_grideffect.md).GridEffect
...
\+ **new GridEffect**(`__namedParameters?`: { `blendFunction`:  ; `lineWidth`:  ; `scale`:   }): [*GridEffect*](renderer_postprocessing_grideffect.grideffect.md)
...
`__namedParameters.lineWidth` | - |
`__namedParameters.scale` | - |

**Returns:** [*GridEffect*](renderer_postprocessing_grideffect.grideffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:13](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L13)
...
Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:11](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L11)
...
Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:12](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L12)
...
Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:90](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L90)
...
Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:69](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L69)
...
Name | Type | Description |
:------ | :------ | :------ |
`lineWidth` | *any* | The new grid line width.    |

**Returns:** *void*

Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:100](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L100)
...
Name | Type | Description |
:------ | :------ | :------ |
`scale` | *any* | The new grid scale.    |

**Returns:** *void*

Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:79](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L79)
...
Defined in: [packages/engine/src/renderer/postprocessing/GridEffect.ts:112](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/GridEffect.ts#L112)
