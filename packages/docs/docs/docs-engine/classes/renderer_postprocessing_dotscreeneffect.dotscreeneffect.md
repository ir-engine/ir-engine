---
id: "renderer_postprocessing_dotscreeneffect.dotscreeneffect"
title: "Class: DotScreenEffect"
sidebar_label: "DotScreenEffect"
custom_edit_url: null
hide_title: true
---

# Class: DotScreenEffect

[renderer/postprocessing/DotScreenEffect](../modules/renderer_postprocessing_dotscreeneffect.md).DotScreenEffect
...
\+ **new DotScreenEffect**(`__namedParameters?`: { `angle`:  ; `blendFunction`:  ; `scale`:   }): [*DotScreenEffect*](renderer_postprocessing_dotscreeneffect.dotscreeneffect.md)
...
`__namedParameters.angle` | - |
`__namedParameters.blendFunction` | - |
`__namedParameters.scale` | - |

**Returns:** [*DotScreenEffect*](renderer_postprocessing_dotscreeneffect.dotscreeneffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/DotScreenEffect.ts:11](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/DotScreenEffect.ts#L11)
...
Defined in: [packages/engine/src/renderer/postprocessing/DotScreenEffect.ts:42](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/DotScreenEffect.ts#L42)
