---
id: "interaction_components_subfocused.subfocused"
title: "Class: SubFocused"
sidebar_label: "SubFocused"
...
[interaction/components/SubFocused](../modules/interaction_components_subfocused.md).SubFocused

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*SubFocused*](interaction_components_subfocused.subfocused.md)\>
...
\+ **new SubFocused**(`props?`: *false* \| *Partial*<Omit<[*SubFocused*](interaction_components_subfocused.subfocused.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*SubFocused*](interaction_components_subfocused.subfocused.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*SubFocused*](interaction_components_subfocused.subfocused.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*SubFocused*](interaction_components_subfocused.subfocused.md)
...
• **subInteracts**: [*Entity*](ecs_classes_entity.entity.md)

Defined in: [packages/engine/src/interaction/components/SubFocused.ts:6](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/interaction/components/SubFocused.ts#L6)
...
:------ | :------ |
`subInteracts` | *object* |
`subInteracts.type` | [*PropType*](../interfaces/ecs_types_types.proptype.md)<unknown, any\> |

Overrides: [Component](ecs_classes_component.component.md).[_schema](ecs_classes_component.component.md#_schema)

Defined in: [packages/engine/src/interaction/components/SubFocused.ts:8](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/interaction/components/SubFocused.ts#L8)
