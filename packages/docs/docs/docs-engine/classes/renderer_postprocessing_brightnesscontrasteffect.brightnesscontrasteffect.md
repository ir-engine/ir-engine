---
id: "renderer_postprocessing_brightnesscontrasteffect.brightnesscontrasteffect"
title: "Class: BrightnessContrastEffect"
sidebar_label: "BrightnessContrastEffect"
...
[renderer/postprocessing/BrightnessContrastEffect](../modules/renderer_postprocessing_brightnesscontrasteffect.md).BrightnessContrastEffect
...
\+ **new BrightnessContrastEffect**(`__namedParameters?`: { `blendFunction`:  ; `brightness`:  ; `contrast`:   }): [*BrightnessContrastEffect*](renderer_postprocessing_brightnesscontrasteffect.brightnesscontrasteffect.md)
...
`__namedParameters.brightness` | - |
`__namedParameters.contrast` | - |

**Returns:** [*BrightnessContrastEffect*](renderer_postprocessing_brightnesscontrasteffect.brightnesscontrasteffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/BrightnessContrastEffect.ts:12](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/BrightnessContrastEffect.ts#L12)
