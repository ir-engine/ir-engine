---
id: "transform_components_transformchildcomponent.transformchildcomponent"
title: "Class: TransformChildComponent"
sidebar_label: "TransformChildComponent"
custom_edit_url: null
hide_title: true
---

# Class: TransformChildComponent

[transform/components/TransformChildComponent](../modules/transform_components_transformchildcomponent.md).TransformChildComponent

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*TransformChildComponent*](transform_components_transformchildcomponent.transformchildcomponent.md)\>
...
\+ **new TransformChildComponent**(`props?`: *false* \| *Partial*<Omit<[*TransformChildComponent*](transform_components_transformchildcomponent.transformchildcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*TransformChildComponent*](transform_components_transformchildcomponent.transformchildcomponent.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*TransformChildComponent*](transform_components_transformchildcomponent.transformchildcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*TransformChildComponent*](transform_components_transformchildcomponent.transformchildcomponent.md)
...
Defined in: [packages/engine/src/transform/components/TransformChildComponent.ts:7](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/transform/components/TransformChildComponent.ts#L7)

___

### offsetQuaternion

• **offsetQuaternion**: *any*

Defined in: [packages/engine/src/transform/components/TransformChildComponent.ts:8](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/transform/components/TransformChildComponent.ts#L8)
...
Defined in: [packages/engine/src/transform/components/TransformChildComponent.ts:6](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/transform/components/TransformChildComponent.ts#L6)
