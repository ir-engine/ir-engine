---
id: "physics_components_rigidbody.rigidbody"
title: "Class: RigidBody"
...
[physics/components/RigidBody](../modules/physics_components_rigidbody.md).RigidBody
...
\+ **new RigidBody**(`props?`: *false* \| *Partial*<Omit<any, keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*RigidBody*](physics_components_rigidbody.rigidbody.md)
...
**Returns:** [*RigidBody*](physics_components_rigidbody.rigidbody.md)
...
• **isKinematic**: *number*= 0

Defined in: [packages/engine/src/physics/components/RigidBody.ts:5](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/physics/components/RigidBody.ts#L5)
