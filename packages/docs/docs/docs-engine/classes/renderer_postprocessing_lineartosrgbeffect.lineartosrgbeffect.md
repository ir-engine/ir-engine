---
id: "renderer_postprocessing_lineartosrgbeffect.lineartosrgbeffect"
title: "Class: LinearTosRGBEffect"
sidebar_label: "LinearTosRGBEffect"
...
[renderer/postprocessing/LinearTosRGBEffect](../modules/renderer_postprocessing_lineartosrgbeffect.md).LinearTosRGBEffect
...
\+ **new LinearTosRGBEffect**(`__namedParameters?`: { `blendFunction`:   }): [*LinearTosRGBEffect*](renderer_postprocessing_lineartosrgbeffect.lineartosrgbeffect.md)
...
**Returns:** [*LinearTosRGBEffect*](renderer_postprocessing_lineartosrgbeffect.lineartosrgbeffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/LinearTosRGBEffect.ts:7](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/LinearTosRGBEffect.ts#L7)
