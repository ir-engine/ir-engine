---
id: "renderer_postprocessing_deptheffect.deptheffect"
title: "Class: DepthEffect"
sidebar_label: "DepthEffect"
...
[renderer/postprocessing/DepthEffect](../modules/renderer_postprocessing_deptheffect.md).DepthEffect
...
\+ **new DepthEffect**(`__namedParameters?`: { `blendFunction`:  ; `inverted`:   }): [*DepthEffect*](renderer_postprocessing_deptheffect.deptheffect.md)
...
`__namedParameters.inverted` | - |

**Returns:** [*DepthEffect*](renderer_postprocessing_deptheffect.deptheffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/DepthEffect.ts:12](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/DepthEffect.ts#L12)
...
Defined in: [packages/engine/src/renderer/postprocessing/DepthEffect.ts:38](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/DepthEffect.ts#L38)

• set **inverted**(`value`: *any*): *void*
...
Defined in: [packages/engine/src/renderer/postprocessing/DepthEffect.ts:48](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/DepthEffect.ts#L48)
