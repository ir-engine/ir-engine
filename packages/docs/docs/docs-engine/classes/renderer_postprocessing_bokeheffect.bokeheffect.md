---
id: "renderer_postprocessing_bokeheffect.bokeheffect"
title: "Class: BokehEffect"
sidebar_label: "BokehEffect"
...
[renderer/postprocessing/BokehEffect](../modules/renderer_postprocessing_bokeheffect.md).BokehEffect
...
\+ **new BokehEffect**(`__namedParameters?`: { `aperture`:  ; `blendFunction`:  ; `dof`:  ; `focus`:  ; `maxBlur`:   }): [*BokehEffect*](renderer_postprocessing_bokeheffect.bokeheffect.md)
...
`__namedParameters.aperture` | - |
`__namedParameters.blendFunction` | - |
`__namedParameters.dof` | - |
`__namedParameters.focus` | - |
`__namedParameters.maxBlur` | - |

**Returns:** [*BokehEffect*](renderer_postprocessing_bokeheffect.bokeheffect.md)

Overrides: [Effect](renderer_postprocessing_effect.effect.md)

Defined in: [packages/engine/src/renderer/postprocessing/BokehEffect.ts:15](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/renderer/postprocessing/BokehEffect.ts#L15)
