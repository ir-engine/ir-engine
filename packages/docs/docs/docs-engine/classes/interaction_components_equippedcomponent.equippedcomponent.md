---
id: "interaction_components_equippedcomponent.equippedcomponent"
title: "Class: EquippedComponent"
sidebar_label: "EquippedComponent"
...
[interaction/components/EquippedComponent](../modules/interaction_components_equippedcomponent.md).EquippedComponent

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*EquippedComponent*](interaction_components_equippedcomponent.equippedcomponent.md)\>
...
\+ **new EquippedComponent**(`props?`: *false* \| *Partial*<Omit<[*EquippedComponent*](interaction_components_equippedcomponent.equippedcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*EquippedComponent*](interaction_components_equippedcomponent.equippedcomponent.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*EquippedComponent*](interaction_components_equippedcomponent.equippedcomponent.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*EquippedComponent*](interaction_components_equippedcomponent.equippedcomponent.md)
...
Defined in: [packages/engine/src/interaction/components/EquippedComponent.ts:12](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/interaction/components/EquippedComponent.ts#L12)
...
• **equippedEntity**: [*Entity*](ecs_classes_entity.entity.md)

Defined in: [packages/engine/src/interaction/components/EquippedComponent.ts:11](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/interaction/components/EquippedComponent.ts#L11)
...
`equippedEntity` | *object* |
`equippedEntity.default` | *any* |
`equippedEntity.type` | [*PropType*](../interfaces/ecs_types_types.proptype.md)<unknown, any\> |

Overrides: [Component](ecs_classes_component.component.md).[_schema](ecs_classes_component.component.md#_schema)

Defined in: [packages/engine/src/interaction/components/EquippedComponent.ts:6](https://github.com/xr3ngine/xr3ngine/blob/716a06460/packages/engine/src/interaction/components/EquippedComponent.ts#L6)
