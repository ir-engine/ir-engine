---
id: "input_components_localinputreceiver.localinputreceiver"
title: "Class: LocalInputReceiver"
sidebar_label: "LocalInputReceiver"
custom_edit_url: null
hide_title: true
---

# Class: LocalInputReceiver

[input/components/LocalInputReceiver](../modules/input_components_localinputreceiver.md).LocalInputReceiver

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*LocalInputReceiver*](input_components_localinputreceiver.localinputreceiver.md)\>
...
\+ **new LocalInputReceiver**(`props?`: *false* \| *Partial*<Omit<[*LocalInputReceiver*](input_components_localinputreceiver.localinputreceiver.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*LocalInputReceiver*](input_components_localinputreceiver.localinputreceiver.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*LocalInputReceiver*](input_components_localinputreceiver.localinputreceiver.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*LocalInputReceiver*](input_components_localinputreceiver.localinputreceiver.md)
