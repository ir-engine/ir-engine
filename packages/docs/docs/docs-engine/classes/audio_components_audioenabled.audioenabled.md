---
id: "audio_components_audioenabled.audioenabled"
title: "Class: AudioEnabled"
sidebar_label: "AudioEnabled"
...
[audio/components/AudioEnabled](../modules/audio_components_audioenabled.md).AudioEnabled

Component class for indication of enabled audio.

## Hierarchy

* [*Component*](ecs_classes_component.component.md)<[*AudioEnabled*](audio_components_audioenabled.audioenabled.md)\>
...
\+ **new AudioEnabled**(`props?`: *false* \| *Partial*<Omit<[*AudioEnabled*](audio_components_audioenabled.audioenabled.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\>): [*AudioEnabled*](audio_components_audioenabled.audioenabled.md)
...
Name | Type |
:------ | :------ |
`props?` | *false* \| *Partial*<Omit<[*AudioEnabled*](audio_components_audioenabled.audioenabled.md), keyof [*Component*](ecs_classes_component.component.md)<any\>\>\> |

**Returns:** [*AudioEnabled*](audio_components_audioenabled.audioenabled.md)
