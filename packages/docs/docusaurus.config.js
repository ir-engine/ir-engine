...
module.exports = {
  ...
  favicon: 'https://github.com/xrengine/xrengine/raw/dev/xrengine%20black.png',
  ...
  themeConfig: {
    navbar: {
      ...
      logo: {
        alt: 'Logo',
        src: 'https://github.com/xrengine/xrengine/raw/dev/xrengine%20black.png',
      },
      items: [
        {
          to: 'docs/',
        ...
        {
          href: 'https://github.com/xrengine/xrengine',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xrengine/xrengine/edit/jsdoc/packages/docs/',
        },
        // blog: {
