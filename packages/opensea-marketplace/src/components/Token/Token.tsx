...
// const Token = ({ token, isOnSale, onTransfer, onBuy, onSale,pdata,ind }: TokenCompProps) => {
...
//       transferToken(pdata?.id, address)
//       setTransfer(false)
//     }
//   }
...
//     e.preventDefault()
//     onBuy && buyToken(pdata?.id, pdata?.price)
//   }
...
//     if (!onSale) return
//     try {
//       await setTokenSale(pdata?.id, utils.parseEther(price), true)
//       setOnSale(false)
//     } catch (e) {
//       throw new Error(e)
//     }
...
//       />
//       <Box p={3} pt={2}>
//         <Heading as="h2"> {data.name}
//          {/* {
//            data.attributes.map((d:any)=>{
//              return(
//                 <span>{d.trait_type}</span>
//              )
//            })
//          } */}
//         </Heading>
...
//             {constants.EtherSymbol} {Number(utils.formatEther(pdata?.price)).toFixed(2)}{' '}
...
//             <NavLink
//               target="_blank"
//               href={`https://testnets.opensea.io/assets/${contractDetails?.address}/${pdata?.id}`}
//               variant="openSea"
//             >
//               View on Opensea.io
//             </NavLink>
...
//                   <Button
//                     mt={2}
//                     onClick={() => onSale && setTokenSale(pdata?.id, pdata?.price, false)}
//                     variant="tertiary"
//                   >
//                     Remove from Sale
//                   </Button>
...
//                   a => utils.formatUnits(a.id) === utils.formatUnits(pdata?.id)
//                 )
//                   ? 0.5
//                   : 1,
