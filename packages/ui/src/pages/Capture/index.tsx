          ...
          <div className="w-full px-2">
            <div className="w-full relative ">
              <div className="relative w-full h-auto max-w-full" style={{ backgroundColor: '#000000' }}>
                <Video ref={videoRef} className="min-w-full h-auto max-w-full" />
              </div>
              <div
                className="object-contain absolute top-0 z-20 min-w-full h-auto max-w-full"
              ...
              {videoStatus !== 'active' ? (
                <button
                  ...
                  className="absolute btn btn-ghost bg-none h-full w-full container mx-auto m-0 p-0 top-0"
                >
