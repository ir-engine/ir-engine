...
import ImportSettingsPanel from '@etherealengine/editor/src/components/assets/ImportSettingsPanel'
...
import ProgressDialog from '@etherealengine/editor/src/components/dialogs/ProgressDialog'
...
} from '@etherealengine/editor/src/functions/sceneFunctions'
...
import { HierarchyPanelTab } from '../../components/editor/panels/Hierarchy'

import { AssetsPanelTab } from '../../components/editor/panels/Assets'
import { MaterialsPanelTab } from '../../components/editor/panels/Materials'
import { PropertiesPanelTab } from '../../components/editor/panels/Properties'
import { ScenePanelTab } from '../../components/editor/panels/Scenes'
import { ViewportPanelTab } from '../../components/editor/panels/Viewport'
import { VisualScriptPanelTab } from '../../components/editor/panels/VisualScript'
...
const onSaveScene = async (gltf = false) => {
  ...
  const result = (await new Promise((resolve) => {
    DialogState.setDialog(
      <></>
      //<SaveSceneDialog onConfirm={resolve} onCancel={resolve} />
    )
  })) as any
    ...
    children: [
      {
        ...
        children: [
          {
            tabs: [ScenePanelTab, AssetsPanelTab] //ProjectBrowserPanelTab]
          }
        ]
      },
      {
...
const EditorContainer = () => {
  ...
  const errorState = useHookstate(getMutableState(EditorState).error)
