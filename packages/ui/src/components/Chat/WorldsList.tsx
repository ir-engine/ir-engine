...
export const WorldsList = () => {
  ...
  return (
    <div className="w-full h-[66vh] overflow-scroll hide-scroll mt-[8px]">
      {instances.value.map((item, index) => {
        return (
          ...
          >
            ...
            <div className="">
              <p className="mt-3 h-4 text-xs text-[#787589]">
                {item.currentUsers + ' User' + (item.currentUsers === 1 ? '' : 's')}
              </p>
            </div>
          </div>
        )
