...
export default {
  title: 'Editor/Properties/Gltf/Transform',
  component: Component,
  parameters: {
    componentSubtitle: 'GltfTransformNodeEditor',
    jest: 'gltfTransformNodeEditor.test.tsx',
    design: {
      type: 'figma',
      url: ''
    }
...
const GLTFTransformPropertiesRenderer = (args) => {
  ...
  return <Component transformParms={dummyTransformParams} itemCount={args.itemCount} />
}
