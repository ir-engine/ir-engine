...
const MapPin = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <rect width={139} height={63} x={328.5} y={0.5} stroke="#9747FF" strokeDasharray="10 5" rx={4.5} />
    ...
    <g stroke="#374151" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}>
