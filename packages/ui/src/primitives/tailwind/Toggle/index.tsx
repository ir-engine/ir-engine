...
const Toggle = ({
  ...
  const twClassName = twMerge(
    ...
    'peer-checked:bg-blue-500 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:bg-blue-500 peer-focus:ring-4 dark:border-gray-600 dark:bg-gray-700 dark:peer-focus:bg-blue-500',
