...
import { TransformControlsEcs } from '@etherealengine/engine/src/scene/classes/TransformGizmoECS'
...
export const TransformGizmoEcsComponent = defineComponent({
  name: 'TransformEcsGizmo',

  onInit(entity) {
    const control = new TransformControlsEcs(
  ...
  reactor: function (props) {
    ...
    const gizmoComponent = useComponent(entity, TransformGizmoEcsComponent)
