...
import ProjectFields from '@etherealengine/client-core/src/admin2/common/Project/ProjectFields'
...
import { ProjectUpdateState } from '@etherealengine/client-core/src/admin2/services/ProjectUpdateService'
