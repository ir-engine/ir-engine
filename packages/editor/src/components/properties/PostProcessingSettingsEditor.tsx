...
import { Effects } from '@etherealengine/engine/src/renderer/effects/PostProcessing'
...
const EffectsOptions: EffectOptionsType = {
  ...
  SSREffect: {
    ...
    radius: { propertyType: PropertyTypes.Number, name: 'Denoise Specular', min: 0, max: 50, step: 0.01 },
    phi: { propertyType: PropertyTypes.Number, name: 'Denoise Specular', min: 0, max: 50, step: 0.01 },
    ...
    specularPhi: { propertyType: PropertyTypes.Number, name: 'Denoise Specular', min: 0, max: 50, step: 0.01 },
