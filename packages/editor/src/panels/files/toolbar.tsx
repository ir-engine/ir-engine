    ...
    <Popup
      ...
      trigger={
        <Tooltip content={t('editor:layout.filebrowser.view-mode.settings.name')}>
          <Button startIcon={<IoSettingsSharp />} className="h-7 w-7 rounded-lg bg-[#2C2E33] p-0" />
        </Tooltip>
      }
    >
...
export default function FilesToolbar() {
  ...
  return (
    <div className="mb-1 flex h-9 items-center gap-2 bg-[#212226]">
      ...
      <div id="refreshDir" className="flex h-7 w-7 items-center rounded-lg bg-[#2C2E33]">
      ...
      <div className="w-30 flex h-7 flex-row items-center gap-1 rounded-lg bg-[#2C2E33] px-2 py-1 ">
      ...
      <div id="downloadProject" className="flex h-7 w-7 items-center rounded-lg bg-[#2C2E33]">
        <Tooltip
          content={
            showDownloadButtons
      ...
      <div id="newFolder" className="flex h-7 w-7 items-center rounded-lg bg-[#2C2E33]">
