...
function extractorsFactory(extractWeights: ExtractWeightsFunction, paramMappings: ParamMapping[]) {
  ...
  function extractConvParams(
    ...
    const filters = tf.tensor4d(extractWeights(channelsIn * channelsOut * filterSize * filterSize), [
      filterSize,
      filterSize,
      channelsIn,
      channelsOut
  ...
  function extractConvPairParams(channelsIn: number, channelsOut: number, mappedPrefix: string): ConvPairParams {
