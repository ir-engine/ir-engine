...
export const clientHost = localBuildOrDev && process.env.VITE_LOCAL_NGINX !== 'true'
...
export const serverHost = localBuildOrDev && process.env.VITE_LOCAL_NGINX !== 'true'
...
export const instanceserverHost = localBuildOrDev && process.env.VITE_LOCAL_NGINX !== 'true'
...
export const corsProxyPath = localBuildOrDev && process.env.VITE_LOCAL_NGINX !== 'true'
