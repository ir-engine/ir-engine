...
export const helmVersionDataSchema = Type.Object(
  {
    action: Type.String({ enum: ['main', 'builder'], description: 'The type of Helm chart to fetch versions for' })
  },
  { $id: 'HelmVersion', additionalProperties: false }
)
export interface HelmVersionData extends Static<typeof helmVersionDataSchema> {}
...
export const helmVersionDataValidator = /* @__PURE__ */ getValidator(helmVersionDataSchema, dataValidator)
