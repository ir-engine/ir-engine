...
export const staticResourceFiltersSchema = Type.Object(
  {
    mimeTypes: Type.Array(Type.String())
  },
...
export const staticResourceFiltersQuerySchema = Type.Intersect(
  [
    querySyntax(staticResourceFiltersQueryProperties),
...
export const staticResourceFiltersValidator = /* @__PURE__ */ getValidator(staticResourceFiltersSchema, dataValidator)
export const staticResourceFiltersQueryValidator = /* @__PURE__ */ getValidator(
