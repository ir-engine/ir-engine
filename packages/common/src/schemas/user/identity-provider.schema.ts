...
export const identityProviderDataProperties = Type.Pick(identityProviderSchema, [
  'token',
  'accountIdentifier',
  'oauthToken',
  'type'
...
export const identityProviderDataSchema = Type.Intersect(
  [
    identityProviderDataProperties,
    Type.Object(
      {
