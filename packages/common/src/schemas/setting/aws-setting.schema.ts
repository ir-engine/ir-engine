...
export const awsKeysValidator = /* @__PURE__ */ getValidator(awsKeysSchema, dataValidator)
export const awsEksValidator = /* @__PURE__ */ getValidator(awsEksSchema, dataValidator)
export const awsS3Validator = /* @__PURE__ */ getValidator(awsS3Schema, dataValidator)
export const awsCloudFrontValidator = /* @__PURE__ */ getValidator(awsCloudFrontSchema, dataValidator)
export const awsSmsValidator = /* @__PURE__ */ getValidator(awsSmsSchema, dataValidator)
export const awsSettingValidator = /* @__PURE__ */ getValidator(awsSettingSchema, dataValidator)
export const awsSettingDataValidator = /* @__PURE__ */ getValidator(awsSettingDataSchema, dataValidator)
export const awsSettingPatchValidator = /* @__PURE__ */ getValidator(awsSettingPatchSchema, dataValidator)
export const awsSettingQueryValidator = /* @__PURE__ */ getValidator(awsSettingQuerySchema, queryValidator)
