import { FEEDS_ADMIN_RETRIEVED, ADMIN_FEEDS_FETCH, ADD_AS_ADMIN_FEED, UPDATE_ADMIN_FEED, REMOVE_FEED } from '../actions'
import { FeedShort, Feed } from '@xrengine/common/src/interfaces/Feed'
import { FeedsAction } from '@xrengine/social/src/reducers/feed/actions'
