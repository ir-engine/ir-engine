...
export const createParticleEmitter = (entity, configs): void => {
  ...
  args.startVelocity = new Vector3(args.startVelocity);
  args.endVelocity = new Vector3(args.endVelocity);

  addComponent(entity, ParticleEmitter, args);
}
