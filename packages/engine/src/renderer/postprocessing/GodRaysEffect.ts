...
import { DepthMaskMaterial } from './materials/DepthMaskMaterial';
import { GodRaysMaterial } from './materials/GodRaysMaterial';
...
export class GodRaysEffect extends Effect {
  ...
  constructor (camera, lightSource, {
    ...
    (this as any).uniforms.get('texture').value = this.renderTargetB.texture;
    ...
    this.renderTargetLight.depthTexture = new DepthTexture(512, 512);
