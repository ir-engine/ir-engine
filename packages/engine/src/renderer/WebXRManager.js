import { ArrayCamera, EventDispatcher, PerspectiveCamera, Vector3, Vector4, WebGLRenderTarget, DepthTexture, 
	DepthFormat,
	DepthStencilFormat,
	RGBAFormat,
	UnsignedByteType,
...
class WebXRManager extends EventDispatcher {
	...
	constructor( renderer, gl ) {
		...
		const controllerInputSources = this.controllerInputSources = [];
