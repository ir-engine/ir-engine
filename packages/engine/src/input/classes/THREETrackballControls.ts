...
export class THREETrackballControls extends EventDispatcher {
  ...
  private readonly _movePrev: Vector2
  private readonly _moveCurr: Vector2
  private readonly _lastAxis: Vector3
  private _lastAngle: number
  private readonly _zoomStart: Vector2
  private readonly _zoomEnd: Vector2
  private _touchZoomDistanceStart: number
  private _touchZoomDistanceEnd: number
  private readonly _panStart: Vector2
  private readonly _panEnd: Vector2

  private readonly target0: Vector3
  private readonly position0: Vector3
  private readonly up0: Vector3
