...
function readNodeParameterJSON(valuesRegistry: ValueTypeMap, node: INode, parametersJson: NodeParametersJSON) {
...
function readVariablesJSON(valuesRegistry: ValueTypeMap, variablesJson: VariableJSON[]) {
...
function readCustomEventsJSON(valuesRegistry: ValueTypeMap, customEventsJson: CustomEventJSON[]) {
