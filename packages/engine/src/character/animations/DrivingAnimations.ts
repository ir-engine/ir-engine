...
const getInputData = (
  ...
  result.inputValue =
    inputData.lifecycleState === LifecycleValue.ENDED ||
...
const drivingAnimationSchema = [
  {
    type: [DRIVING],
    name: defaultAvatarAnimations[DRIVING].name,
    axis: 'xyz',
    speed: 1,
    customProperties: ['weight', 'test'],
    value: [-0.5, 0, 0.5],
    weight: [0, 0, 0],
    test: [0, 1, 0]
  },
  {
    type: [ENTERING_VEHICLE_DRIVER],
    name: defaultAvatarAnimations[ENTERING_VEHICLE_DRIVER].name,
    axis: 'z',
    speed: 0.5,
    customProperties: ['weight', 'test'],
    value: [0, 1],
  ...
  {
    type: [EXITING_VEHICLE_DRIVER],
    name: defaultAvatarAnimations[EXITING_VEHICLE_DRIVER].name,
    axis: 'z',
    speed: 0.5,
    customProperties: ['weight', 'test'],
    value: [-1, 0],
