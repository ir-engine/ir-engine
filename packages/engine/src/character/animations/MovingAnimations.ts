...
export const movingAnimationSchema = [
  {
    type: [IDLE],
    name: defaultAvatarAnimations[IDLE].name,
    axis: 'xyz',
    speed: 0.9,
    customProperties: ['weight', 'dontHasHit'],
  ...
  {
    type: [FALLING],
    name: defaultAvatarAnimations[FALLING].name,
    axis: 'xyz',
    speed: 0.5,
    customProperties: ['weight', 'dontHasHit'],
    value: [-1, 0, 1],
  ...
  {
    type: [DROP],
    name: defaultAvatarAnimations[DROP].name,
    axis: 'y',
    speed: 0.1,
    customProperties: ['weight', 'dontHasHit'],
    value: [-1, -0.1],
  ...
  */
  {
    type: [WALK_FORWARD],
    name: defaultAvatarAnimations[WALK_FORWARD].name,
    axis: 'z',
    speed: 0.6,
    customProperties: ['weight', 'dontHasHit'],
    value: [0.1, 0.5, 1],
  ...
  },
  {
    ...
    name: defaultAvatarAnimations[WALK_STRAFE_RIGHT].name,
    axis: 'x',
    speed: 0.6,
    customProperties: ['weight', 'dontHasHit'],
    value: [-1, -0.5, -0.1],
  ...
  },
  {
    ...
    name: defaultAvatarAnimations[WALK_STRAFE_LEFT].name,
    axis: 'x',
    speed: 0.6,
    customProperties: ['weight', 'dontHasHit'],
    value: [0.03, 0.5, 1],
  ...
  {
    type: [WALK_BACKWARD],
    name: defaultAvatarAnimations[WALK_BACKWARD].name,
    axis: 'z',
    speed: 0.6,
    customProperties: ['weight', 'dontHasHit'],
    value: [-1, -0.5, -0.1],
  ...
  {
    type: [RUN_FORWARD],
    name: defaultAvatarAnimations[RUN_FORWARD].name,
    axis: 'z',
    speed: 0.7,
    customProperties: ['weight', 'dontHasHit'],
    value: [0.5, 1],
  ...
  },
  {
    ...
    name: defaultAvatarAnimations[RUN_STRAFE_RIGHT].name,
    axis: 'x',
    speed: 0.7,
    customProperties: ['weight', 'dontHasHit'],
    value: [-1, -0.5],
  ...
  },
  {
    ...
    name: defaultAvatarAnimations[RUN_STRAFE_LEFT].name,
    axis: 'x',
    speed: 0.7,
    customProperties: ['weight', 'dontHasHit'],
    value: [0.5, 1],
  ...
  {
    type: [RUN_BACKWARD],
    name: defaultAvatarAnimations[RUN_BACKWARD].name,
    axis: 'z',
    speed: 0.7,
    customProperties: ['weight', 'dontHasHit'],
    value: [-1, -0.5],
...
export const getMovementValues: Behavior = (entity, args: {}, deltaTime: number) => {
  ...
  if (actor.moveVectorSmooth.position.length() < 0.001) {
    actor.moveVectorSmooth.velocity.set(0, 0, 0)
    actor.moveVectorSmooth.position.set(0, 0, 0)
  }
