...
import { EdgeDetectionMaterial, EdgeDetectionMode } from '../materials/EdgeDetectionMaterial';
import { SMAAWeightsMaterial } from '../materials/SMAAWeightsMaterial';
...
export class SMAAEffect extends Effect {
  ...
  renderTargetWeights: any;
  clearPass: ClearPass;
  edgeDetectionPass: ShaderPass;
