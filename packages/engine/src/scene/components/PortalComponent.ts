...
export const PortalComponent = defineComponent({
  ...
  schema: S.Object({
    linkedPortalId: S.EntityUUID(), /** @todo due to the NodeID refactor, we have to re-think how we reference entities in other assets/scenes, so this will no longer work */
    location: S.String(''),
