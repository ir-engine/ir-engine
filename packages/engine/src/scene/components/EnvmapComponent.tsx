...
import { getObj, useTexture } from '../../assets/functions/resourceHooks'
...
export const EnvmapComponent = defineComponent({
  ...
  reactor: function () {
    ...
    useEffect(() => {
      ...
      const [texture, unload] = getObj(DataTexture, entity, getRGBArray(col), resolution, resolution, RGBAFormat)
