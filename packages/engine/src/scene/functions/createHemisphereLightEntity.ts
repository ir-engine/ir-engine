...
import { Vector3, Quaternion, Euler, HemisphereLight } from "three";
import { VisibleComponent, VisibleData } from "../components/VisibleComponent";
import { HemisphereLightComponent, HemisphereLightData } from "../components/HemisphereLightComponent";

export const createHemisphereLightEntity: EntityCreateFunctionType = (
  entity: Entity,
  ...
  if (componentData[ComponentNames.HEMISPHERE_LIGHT]) {
    addComponent<HemisphereLightData, {}>(
      entity,
      HemisphereLightComponent,
      new HemisphereLightData(light, componentData[ComponentNames.HEMISPHERE_LIGHT])
    )
  }
