...
import EntityTeleportTriggerEditor from '@ir-engine/ui/src/components/editor/properties/entityTeleportTrigger'

// Register the component editor
getMutableState(ComponentEditorsState).merge({ 
  [EntityTeleportTriggerComponent.name]: EntityTeleportTriggerEditor 
})

// Add the component to the Physics category in the component shelf
getMutableState(ComponentShelfCategoriesState).Physics.merge([
  EntityTeleportTriggerComponent
])
