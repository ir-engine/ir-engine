...
class XRArmIK {
  ...
  Start() {
    this.upperArmLength = Helpers.getWorldPosition(this.armature.lowerArm, localVector).distanceTo(Helpers.getWorldPosition(this.armature.upperArm, localVector2));
    this.lowerArmLength = Helpers.getWorldPosition(this.armature.hand, localVector).distanceTo(Helpers.getWorldPosition(this.armature.lowerArm, localVector2));
  ...
  Update() {
    ...
    this.armature.upperArm.quaternion.setFromRotationMatrix(
      localMatrix.lookAt(
        zeroVector,
    ...
    this.armature.lowerArm.quaternion.setFromRotationMatrix(
      localMatrix.lookAt(
        zeroVector,
    ...
    this.armature.hand.quaternion.copy(this.target.quaternion)
