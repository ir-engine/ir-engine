...
export function hasSubscribedToChatSystem(userId, system: string): boolean {
  if (system === undefined || system === '' || userId === undefined || !Engine || !Engine.currentWorld) return false
...
export function subscribeToChatSystem(userId, system: string) {
  if (system === undefined || system === '' || userId === undefined || !Engine || !Engine.currentWorld) return
...
export function getSubscribedChatSystems(userId): string[] {
  if (userId === undefined || !Engine || !Engine.currentWorld) return []
