  ...
  execute = (delta: number): void => {
    ...
    try {
      if (
        ...
        (Network.instance.worldState.editObjects.length > 0) ||
        (Network.instance.worldState.destroyObjects.length > 0) ||
        (Network.instance.worldState.gameState.length > 0) ||
        (Network.instance.worldState.gameStateActions.length > 0)
      ) {
