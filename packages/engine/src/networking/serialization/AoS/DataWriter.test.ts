...
describe('AoS DataWriter', () => {
  ...
  it('should writeTransform', () => {
    ...
    strictEqual(writeView.cursor, 3 * Uint8Array.BYTES_PER_ELEMENT + 6 * Float32Array.BYTES_PER_ELEMENT)
  ...
  it('should writeEntity', () => {
    ...
    strictEqual(
      writeView.cursor,
      1 * Uint32Array.BYTES_PER_ELEMENT + 3 * Uint8Array.BYTES_PER_ELEMENT + 6 * Float32Array.BYTES_PER_ELEMENT
    )
  ...
  it('should writeEntities', () => {
    ...
    const expectedBytes =
      ...
      n * (1 * Uint32Array.BYTES_PER_ELEMENT + 3 * Uint8Array.BYTES_PER_ELEMENT + 6 * Float32Array.BYTES_PER_ELEMENT)
