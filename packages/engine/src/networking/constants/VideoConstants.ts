...
export const CAM_VIDEO_SIMULCAST_ENCODINGS = [
  ...
  { scaleResolutionDownBy: 1, maxBitrate: 30000000 } // 30mbps
]
...
export const SCREEN_SHARE_SIMULCAST_ENCODINGS = [
  { dtx: true, maxBitrate: 6000000, scaleResolutionDownBy: 4 }, // 6mbps
  { dtx: true, maxBitrate: 20000000, scaleResolutionDownBy: 2 }, // 20mbps
  { dtx: true, maxBitrate: 100000000, scaleResolutionDownBy: 1 } // 100mbps
]
