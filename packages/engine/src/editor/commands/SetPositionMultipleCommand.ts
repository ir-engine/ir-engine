...
import arrayShallowEqual from "../../common/utils/arrayShallowEqual";
import { serializeVector3, serializeObject3DArray } from "../../common/utils/debug";
export default class SetPositionMultipleCommand extends Command {
  ...
  execute() {
    this.editor.setPositionMultiple(
      this.objects,
      this.position,
      this.space,
      false
  ...
  toString() {
    return `SetPositionMultipleCommand id: ${
      this.id
