...
export default class CurveEditor extends Object3D {
	_splineHelperObjects = [];
	_splinePointsLength = 4;
	_positions = [];
	_point = new Vector3();
	...
	_geometry = new BoxGeometry( 20, 20, 20 );
	...
	constructor() {
		...
		this.load( [ new Vector3( 289.76843686945404, 452.51481137238443, 56.10018915737797 ),
