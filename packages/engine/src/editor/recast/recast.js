...
var Module = (function () {
  ...
  return (
    function (Module) {
      ...
      } var DYNAMIC_BASE = 5255696; var DYNAMICTOP_PTR = 12784
      ...
      function ___syscall140 (which, varargs) {
        ...
        try {
          var stream = SYSCALLS.getStreamFromFD(); var offset_high = SYSCALLS.get(); var offset_low = SYSCALLS.get(); var result = SYSCALLS.get(); var whence = SYSCALLS.get()
          return 0
        } catch (e) {
        ...
        SYSCALLS.varargs = varargs
        try {
          var stream = SYSCALLS.get(); var iov = SYSCALLS.get(); var iovcnt = SYSCALLS.get()
          var ret = 0
          for (var i = 0;
            i < iovcnt;
            i++) {
