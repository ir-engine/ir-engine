...
import sortEntities from "../../common/utils/sortEntities";
import MeshCombinationGroup from "../MeshCombinationGroup";
import GroupNode from "./GroupNode";
import getNodeWithUUID from "../../common/utils/getNodeWithUUID";
import serializeColor from "../../common/utils/serializeColor";
    ...
    this.traverse(obj => {
      ...
      if (attribution) {
        const attributionKey =
          attribution.url || `${attribution.name}_${attribution.author}`;
