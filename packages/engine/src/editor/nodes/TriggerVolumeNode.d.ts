import { Material, BoxBufferGeometry } from "three";
declare const TriggerVolumeNode_base: {
...
export default class TriggerVolumeNode extends TriggerVolumeNode_base {
    static legacyComponentName: string;
    static nodeName: string;
    static _geometry: BoxBufferGeometry;
