...
import EditorDirectionalLightHelper from "../helpers/EditorDirectionalLightHelper";
export default class DirectionalLightNode extends EditorNodeMixin(
  PhysicalDirectionalLight
) {
