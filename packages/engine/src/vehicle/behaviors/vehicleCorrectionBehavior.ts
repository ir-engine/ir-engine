...
export const vehicleCorrectionBehavior: Behavior = (entity: Entity, args): void => {
  ...
  let offsetqX = 0; let offsetqY = 0; let offsetqZ = 0
  let clientSnapshotEuler = null; let interpolationSnapshotEuler = null; let chassisBodyEuler = null; let correctionQuaternion = null
