...
import { createMaterialEntity, unregisterMaterial } from '../../scene/materials/functions/materialSourcingFunctions'
...
export default async function exportMaterialsGLTF(
  ...
  for (const material of materialEntities) {
    ...
    nuMat.uuid = uuidv4()
    createMaterialEntity(nuMat, getComponent(material, SourceComponent))
    nuMats.push(nuMat)
  }
