...
export class Model<T extends Record<string, unknown> = Record<string, unknown>> {
   ...
   */
  public toBuffer (objectOrArray: SchemaObject<T> | Array<SchemaObject<T>>): ArrayBuffer {
   ...
   */
  public fromBuffer (buffer: ArrayBuffer): SchemaObject<T> | Array<SchemaObject<T>>;
  public fromBuffer (buffer: ArrayBuffer, expect: typeof Model.BUFFER_OBJECT): SchemaObject<T>;
  public fromBuffer (buffer: ArrayBuffer, expect: typeof Model.BUFFER_ARRAY): Array<SchemaObject<T>>;
  public fromBuffer (buffer: ArrayBuffer, expect?: number): SchemaObject<T> | Array<SchemaObject<T>> {
    ...
    const results: Array<SchemaObject<T>> = []
