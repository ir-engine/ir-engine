...
import { Body, BoxObstacle, CapsuleObstacle, Controller, Obstacle, PhysXInstance, BodyType, SHAPES, Shape } from 'three-physx'
...
export class DebugRenderer {
  ...
  private readonly _meshes: Map<number, any> = new Map<number, any>()
  private readonly _obstacles: Map<number, any> = new Map<number, any>()
  private readonly _raycasts: Map<number, any> = new Map<number, any>()
  private readonly _materials: Material[]
  private readonly _sphereGeometry: SphereBufferGeometry
  private readonly _boxGeometry: BoxBufferGeometry
  private readonly _planeGeometry: PlaneBufferGeometry
