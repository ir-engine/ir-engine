...
const asianColor = new Color().setHSL(0.078, 0.34, 0.576)
const africanColor = new Color().setHSL(0.09, 0.83, 0.21)
const caucasianColor = new Color().setHSL(0.062, 0.51, 0.68)
...
export class EthnicSkinBlender {
  ...
  valueOf() {
    const blends = [this.human.factors.getCaucasian(), this.human.factors.getAfrican(), this.human.factors.getAsian()]
