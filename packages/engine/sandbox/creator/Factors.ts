...
export class Factors {
  ...
  maxweightVal: number
  minweightVal: number
  averageweightVal: number
  maxmuscleVal: number
  minmuscleVal: number
  averagemuscleVal: number
  maxheightVal: number
  minheightVal: number
  averageheightVal: number
  maxcupVal: number
  mincupVal: number
  averagecupVal: number
  maxfirmnessVal: number
  minfirmnessVal: number
  averagefirmnessVal: number
  idealproportionsVal: number
  uncommonproportionsVal: number
  regularproportionsVal: number
  blockEthnicUpdates: any
