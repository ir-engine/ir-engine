...
const ProfileModal: React.FC<MProps> = (props) => {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Tab icon={<AccountCircleIcon style={{ fontSize: 15 }}/>} label="User Avatar"/>
          <Tab icon={<SettingsIcon style={{ fontSize: 15 }}/>} label="Settings"/>
          <Tab  icon={<AccountBoxIcon style={{ fontSize: 15 }}/>} label="Accounts"/>
