...
cli.main(async () => {
    try {
        ...
        const templateCodeProjectJSONPath = path.join(appRootPath.path, 'packages/projects/template-code-project/package.json')
        ...
        const templateCodeProjectJSON = JSON.parse(fs.readFileSync(templateCodeProjectJSONPath, { encoding: 'utf-8' }))
        ...
        if (!templateCodeProjectJSON.etherealEngine) templateCodeProjectJSON.etherealEngine = {}
        ...
        templateCodeProjectJSON.etherealEngine.version = serverPackageJSON.version
        ...
        fs.writeFileSync(templateCodeProjectJSONPath,Buffer.from(JSON.stringify(templateCodeProjectJSON, null, 2)))
