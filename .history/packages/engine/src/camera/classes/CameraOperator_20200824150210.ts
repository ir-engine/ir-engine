...
import * as Utils from '../../actor/classes/core/CharacterFunctions';
import { World } from './World';
import { IInputReceiver } from '../../actor/classes/interfaces/IInputReceiver';
...
export class CameraOperator implements IInputReceiver
{
	...
	constructor(camera: THREE.Camera, sensitivityX: number = 1, sensitivityY: number = sensitivityX * 0.8)
	{
		this.world = world;
		this.camera = camera;
