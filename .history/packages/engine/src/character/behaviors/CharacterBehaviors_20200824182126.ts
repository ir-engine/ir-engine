...
import { CollisionGroups } from "../../physics/enums/CollisionGroups";
	...
	export const setPhysicsEnabled: Behavior = (entity, args: { value: boolean }): void => {
		...
		if (args.value === true)
		{
			PhysicsManager.instance.physicsWorld.addBody(character.characterCapsule.body);
		}
		else
		{
			PhysicsManager.instance.physicsWorld.remove(character.characterCapsule.body);
		}
	}
	...
	export const feetRaycast: Behavior = (entity: Entity): void =>
	{
		...
		// Cast the ray
		character.rayHasHit = PhysicsManager.instance.physicsWorld.raycastClosest(start, end, rayCastOptions, character.rayResult);
	}
