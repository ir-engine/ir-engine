...
import { lerp } from "../../common/functions/MathLerpFunctions";
	...
	export const physicsPreStep: Behavior = (entity): void =>
	{
		...
		{
			if (character.raycastBox.visible) {
				character.raycastBox.position.set(args.body.position.x, args.body.position.y - character.rayCastLength - character.raySafeOffset, args.body.position.z);
			}
		}
	}
	...
	export const physicsPostStep: Behavior = (entity): void =>
	{
		...
		// Get velocities
		let simulatedVelocity = new Vector3(args.body.velocity.x, args.body.velocity.y, args.body.velocity.z);
