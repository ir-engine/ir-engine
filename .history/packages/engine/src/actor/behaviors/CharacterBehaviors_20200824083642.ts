...
import _ from "lodash";
	...
	export const setOrientation: Behavior = (vector: Vector3, instantly: boolean = false): void =>
	{
	...
	export const resetOrientation: Behavior = (): void =>
	{
		const forward = Utils.getForward(this);
		this.setOrientation(forward, true);
	}

	export const setBehaviour: Behavior = (behaviour: ICharacterAI): void =>
	{
		behaviour.character = this;
		this.behaviour = behaviour;
	}

	export const setPhysicsEnabled: Behavior = (value: boolean): void {
	...
	export const readCharacterData(gltf: any): void =>
	{
	...
	export const update(timeStep: number): void =>
	{
