...
import { getMutableComponent } from "../../ecs/functions/EntityFunctions";
	...
	{
        getMutableComponent<CharacterComponent>(entity, CharacterComponent).arcadeVelocityInfluence.set(args.x, args.y, args.z);
	}

	export function setViewVector(vector: THREE.Vector3): void
	{
	 ...
	 */
	export function setState(state: ICharacterState): void
	{
	...
	export function setOrientation(vector: THREE.Vector3, instantly: boolean = false): void
	{
	...
	export function getLocalMovementDirection(): THREE.Vector3
	{
	...
	export function getCameraRelativeMovementVector(): THREE.Vector3
	{
	...
	export function enterVehicle(seat: VehicleSeat, entryPoint: THREE.Object3D): void
	{
		this.resetControls();
