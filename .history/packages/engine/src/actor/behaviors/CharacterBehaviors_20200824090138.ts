...
import { TransformComponent } from "../../transform/components/TransformComponent";
	...
	export const update: Behavior = (entity, args: {timeStep: number}): void =>
	{
		...
		if (character.physicsEnabled)
		{
			...
			getWorldPosition(entity, {newPos);

			character.characterCapsule.body.position.copy(Utils.cannonVector(newPos));
			character.characterCapsule.body.interpolatedPosition.copy(Utils.cannonVector(newPos));
		}
	}
