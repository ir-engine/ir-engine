...
import { getForward, setupMeshProperties, cannonVector, getSignedAngleBetweenVectors } from "../classes/core/FunctionLibrary";
...
import { Engine } from "../../ecs/classes/Engine";
	...
	export const takeControl: Behavior = (entity): void =>
	{
    ...
    // Remove me probably
	export const inputReceiverInit: Behavior(entity): void =>
	{
        character = getMutableComponent<CharacterComponent>(entity, CharacterComponent as any)
	...
	export const getLocalMovementDirection: Behavior(entity): Vector3 =>
	{
        character = getMutableComponent<CharacterComponent>(entity, CharacterComponent as any)
	...
	export const getCameraRelativeMovementVector: Behavior = (): Vector3 =>
	{
        character = getMutableComponent<CharacterComponent>(entity, CharacterComponent as any)

		const localDirection = character.getLocalMovementDirection();
	...
	export const setCameraRelativeOrientationTarget: Behavior = (entity): void =>
	{
        character = getMutableComponent<CharacterComponent>(entity, CharacterComponent as any)
