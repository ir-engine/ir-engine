...
import { CapsuleCollider } from '../classes/physics/colliders/CapsuleCollider';
import { VectorSpringSimulator } from '../classes/physics/spring_simulation/VectorSpringSimulator';
import { RelativeSpringSimulator } from '../classes/physics/spring_simulation/RelativeSpringSimulator';
import { RaycastResult } from 'cannon-es';
import { GroundImpactData } from '../classes/characters/GroundImpactData';
import { ICharacterState } from '../classes/interfaces/ICharacterState';
import { CollisionGroups } from '../classes/enums/CollisionGroups';
import { Idle } from '../classes/characters/character_states/Idle';
...
// TODO: Move these... but for now...
	public currentAnimationLength: number
