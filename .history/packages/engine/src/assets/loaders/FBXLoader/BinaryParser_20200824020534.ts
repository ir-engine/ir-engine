  ...
  parseProperty(reader) {
    ...
    switch (type) {
      ...
      case 'l':
        ...
        console.log("Attempt inflate")
        Zlib.inflate(new Uint8Array(reader.getArrayBuffer(compressedLength)), (error, buffer) => {
          if(error !== null) console.log("Error", error)
          console.log("Inflate")
          console.log(buffer);
          console.log("reader2")

          const reader2 = new BinaryReader(buffer.buffer);
          console.log(reader2)
          switch (type) {
