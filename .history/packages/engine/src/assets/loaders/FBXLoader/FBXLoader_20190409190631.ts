...
class FBXTreeParser<IFBXTreeParser> {
  ...
  parseScene( deformers, geometryMap, materialMap ) {
    ...
    FBXLoader.sceneGraph = new THREE.Group();
  ...
  createAmbientLight() {
    ...
    if ( 'GlobalSettings' in FBXLoader.fbxTree && 'AmbientColor' in FBXLoader.fbxTree.GlobalSettings ) {
      ...
      if ( r !== 0 || g !== 0 || b !== 0 ) {
        ...
        FBXLoader.sceneGraph.add( new THREE.AmbientLight( color, 1 ) );
...
class GeometryParser {
  ...
  genMorphGeometry( parentGeo, parentGeoNode, morphGeoNode, preTransform, name ) {
    ...
    const positionAttribute: any = new THREE.Float32BufferAttribute( morphBuffers.vertex, 3 );
