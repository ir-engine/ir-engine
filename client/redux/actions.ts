...
export const LOADED_GROUP_USERS = 'LOADED_GROUP_USERS'
export const LOADED_SELF_GROUP_USER = 'LOADED_SELF_GROUP_USER'
...
export const FETCHING_SELF_GROUP_USER = 'FETCHING_SELF_GROUP_USER'
...
export const LOADED_PARTY_USERS = 'LOADED_PARTY_USERS'
export const LOADED_SELF_PARTY_USER = 'LOADED_SELF_PARTY_USER'
...
export const FETCHING_PARTY_USERS = 'FETCHING_PARTY_USERS'
export const FETCHING_SELF_PARTY_USER = 'FETCHING_SELF_PARTY_USER'
export const LEFT_PARTY = 'LEFT_PARTY'

export const LOADED_USER_CHANNELS = 'LOADED_USER_CHANNELS'
export const LOADED_GROUP_CHANNELS = 'LOADED_GROUP_CHANNELS'
export const LOADED_PARTY_CHANNEL = 'LOADED_PARTY_CHANNEL'
